...
#       Shared        #
#---------------------#
useRelativeLoopToolsPath = True								# Set True if you want to set the path to LoopTools relative to the 2HDECAY installation path (useful if you installed LoopTools e.g. in a subdirectory of the 2HDECAY folder) or False if you want to use an absolute path to LoopTools
