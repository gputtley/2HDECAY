...
def createElectroweakCorrections():
	...
	electroweakCorrectionsFile.write("\tinteger, parameter :: maxNumberSchemes = 17\n")
	...
	electroweakCorrectionsFile.write("\tdouble precision alphaScheme(maxNumberSchemes), alphaDistr, betaScheme(maxNumberSchemes), betaDistr\n")
	electroweakCorrectionsFile.write("\tdouble precision alphaOrig, betaOrig, m12squaredOrig\n")
	electroweakCorrectionsFile.write("\tdouble precision dm122MSBarTemp, dm122MSBarDiff\n")
	electroweakCorrectionsFile.write("\tdouble precision alphaAtMT, betaAtMT\n")
	electroweakCorrectionsFile.write("\tinteger m, n, o, p, q, r, fileNameLength, point, statWrite\n\n")

	electroweakCorrectionsFile.write("\t! Copyright (C) 2018-2019, Marcel Krause, Milada Margarete Muehlleitner and Michael Spira\n\n")
	...
	electroweakCorrectionsFile.write("\t! in the 2HDECAY root directory.\n\n")
	...
	electroweakCorrectionsFile.write('\t\t\talphaOrig = alpha\n')
	...
	electroweakCorrectionsFile.write('\t\t\t! Evolve alpha and beta to the top scale for the gamma_top calculation in HDECAY\n')
	electroweakCorrectionsFile.write('\t\t\talpha = alphaOrig\n')
	electroweakCorrectionsFile.write('\t\t\tbeta = betaOrig\n')
	electroweakCorrectionsFile.write('\t\t\tm12squared = m12squaredOrig\n')
	electroweakCorrectionsFile.write('\t\t\talphaAtMT = alpha\n')
	electroweakCorrectionsFile.write('\t\t\tbetaAtMT = beta\n')
	electroweakCorrectionsFile.write('\t\t\tif (RenormScheme .EQ. 16) then\n')
	electroweakCorrectionsFile.write('\t\t\t\tEvalScale = InputScale\n')
	electroweakCorrectionsFile.write('\t\t\t\talphaDistr = dAlphaMSBarUsual()\n')
	electroweakCorrectionsFile.write('\t\t\t\tbetaDistr = dBetaMSBarUsual()\n')
	electroweakCorrectionsFile.write('\t\t\t\tEvalScale = MT\n')
	electroweakCorrectionsFile.write('\t\t\t\talphaAtMT = alphaOrig + alphaDistr - dAlphaMSBarUsual()\n')
	electroweakCorrectionsFile.write('\t\t\t\tbetaAtMT = betaOrig + betaDistr - dBetaMSBarUsual()\n')
	electroweakCorrectionsFile.write('\t\t\tend if\n')
	electroweakCorrectionsFile.write('\t\t\tif (RenormScheme .EQ. 17) then\n')
	electroweakCorrectionsFile.write('\t\t\t\tEvalScale = InputScale\n')
	electroweakCorrectionsFile.write('\t\t\t\talphaDistr = dAlphaMSBarAlter()\n')
	electroweakCorrectionsFile.write('\t\t\t\tbetaDistr = dBetaMSBarAlter()\n')
	electroweakCorrectionsFile.write('\t\t\t\tEvalScale = MT\n')
	electroweakCorrectionsFile.write('\t\t\t\talphaAtMT = alphaOrig + alphaDistr - dAlphaMSBarAlter()\n')
	...
	electroweakCorrectionsFile.write('\t\t\t\t\twrite( tempVal, \'(ES23.15E3)\' ) alphaAtMT\n')
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent2 = trim(outputFileContent2) // "alpha ="\n')
	...
	for x in range(0, len(processDescriptionList)):
		...
		for y in range(0, (32 - len(processDescriptionList[x][1]))):
			starString += "*"
		starString2 = ""
		for y in range(0, (25 - len(previousDecayparticle))):
			starString2 += "*"
		...
		electroweakCorrectionsFile.write("\t\t\t\t\t! Get the original values of alpha, beta and m12squared and calculate the angle-dependent parameters\n")
		electroweakCorrectionsFile.write('\t\t\t\t\talpha = alphaOrig\n')
		electroweakCorrectionsFile.write('\t\t\t\t\tbeta = betaOrig\n')
		electroweakCorrectionsFile.write('\t\t\t\t\tm12squared = m12squaredOrig\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t! Get the parameters alpha and beta in every scheme\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\tselect case (RefScheme)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (0)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = 0D0\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = 0D0\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (1)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaKanUsual()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaKanAlter()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaPinchPStar()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaPinchOS()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaProcDep1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaProcDep1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (10)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaProcDep2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaProcDep2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (11)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaProcDep3Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaProcDep3Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (12)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaOS1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaOS1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (13)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaOS2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaOS2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (14)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaOS12Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaOS12Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (15)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaPinchOS()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaBFMSAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (16)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tEvalScale = InputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaMSBarUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaMSBarUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcase (17)\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tEvalScale = InputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaMSBarAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaMSBarAlter()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tdo m = 1, maxNumberSchemes, 1\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaScheme(m) = alpha\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = OutputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(16) = alphaOrig + alphaDistr - dAlphaMSBarUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = InputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaDistr = dAlphaMSBarAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = OutputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(17) = alphaOrig + alphaDistr - dAlphaMSBarAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = InputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaDistr = dBetaMSBarUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = OutputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(16) = betaOrig + betaDistr - dBetaMSBarUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = InputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaDistr = dBetaMSBarAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = OutputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(17) = betaOrig + betaDistr - dBetaMSBarAlter()\n')

		electroweakCorrectionsFile.write('\t\t\t\t\t\telse\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tcall clearcache\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tEvalScale = OutputScale\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(1) = alphaOrig + alphaDistr - dAlphaKanUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(2) = alphaOrig + alphaDistr - dAlphaKanUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(3) = alphaOrig + alphaDistr - dAlphaKanAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(4) = alphaOrig + alphaDistr - dAlphaKanAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(5) = alphaOrig + alphaDistr - dAlphaPinchPStar()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(6) = alphaOrig + alphaDistr - dAlphaPinchPStar()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(7) = alphaOrig + alphaDistr - dAlphaPinchOS()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(8) = alphaOrig + alphaDistr - dAlphaPinchOS()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(9) = alphaOrig + alphaDistr - dAlphaProcDep1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(10) = alphaOrig + alphaDistr - dAlphaProcDep2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(11) = alphaOrig + alphaDistr - dAlphaProcDep3Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(12) = alphaOrig + alphaDistr - dAlphaOS1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(13) = alphaOrig + alphaDistr - dAlphaOS2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(14) = alphaOrig + alphaDistr - dAlphaOS12Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(15) = alphaOrig + alphaDistr - dAlphaPinchOS()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(16) = alphaOrig + alphaDistr - dAlphaMSBarUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(17) = alphaOrig + alphaDistr - dAlphaMSBarAlter()\n\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(9) = betaOrig + betaDistr - dBetaProcDep1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(10) = betaOrig + betaDistr - dBetaProcDep2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(11) = betaOrig + betaDistr - dBetaProcDep3Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(12) = betaOrig + betaDistr - dBetaOS1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(13) = betaOrig + betaDistr - dBetaOS2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(14) = betaOrig + betaDistr - dBetaOS12Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(15) = betaOrig + betaDistr - dBetaBFMSAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(16) = betaOrig + betaDistr - dBetaMSBarUsual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(17) = betaOrig + betaDistr - dBetaMSBarAlter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\tend if\n\n')
		...
		if decayHeaderNeed:
			...
			electroweakCorrectionsFile.write('\t\t\t\t\t\toutputFileContent = trim(outputFileContent) // " (mixing angles and m12^2) ' + starString2 + '\\n"\n\n')

			electroweakCorrectionsFile.write('\t\t\t\t\t\t! Write the values of alpha, beta and m12squared in the chosen scheme(s) to the output file\n')
			electroweakCorrectionsFile.write('\t\t\t\t\t\tif (RenormScheme .EQ. 0) then\n')
			electroweakCorrectionsFile.write('\t\t\t\t\t\t\tdo m = 1, maxNumberSchemes, 1\n')
			electroweakCorrectionsFile.write("\t\t\t\t\t\t\t\twrite( tempVal, '(ES23.15E3)' ) alphaScheme(m)\n")
			...
			electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\t\toutputFileContent = trim(outputFileContent) // "alpha" // trim(tempVal2) // "              ="\n')
			electroweakCorrectionsFile.write("\t\t\t\t\t\t\t\telse\n")
			electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\t\toutputFileContent = trim(outputFileContent) // "alpha" // "1" // trim(tempVal3) // "             ="\n')
			electroweakCorrectionsFile.write("\t\t\t\t\t\t\t\tend if\n")
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\t! Grab the current values of alpha and beta and calculate the angle-dependent parameters\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talpha = alphaScheme(m)\n')
