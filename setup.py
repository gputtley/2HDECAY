...
def createElectroweakCorrections():
	...
	electroweakCorrectionsFile.write("\tcharacter(len=20) :: tempVal\n")
	...
	electroweakCorrectionsFile.write("\tcharacter(300), parameter :: pathToOutputFiles = 'Temp\\\\Results\\\\'\n")
	...
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = "MHH,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "Mh0,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "MA0,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "MHp,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "alpha,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "beta,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "m122,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "Lambda5,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "2HDMType,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "InputScale,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthLO,"\n')
	electroweakCorrectionsFile.write("\t\t\tif (debugModeOn) then\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "WidthNLOVC,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "WidthNLOVCwoIR,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "WidthIRonly,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMW2Usual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMW2Alter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMZ2Usual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMZ2Alter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMLOSUsual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMLOSAlter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMBOSUsual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dMBOSAlter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZHHHHOS,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZHHh0OSUsual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZHHh0OSAlter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZh0HHOSUsual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZh0HHOSAlter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZh0h0OS,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZA0A0OS,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZG0A0OSUsual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZG0A0OSAlter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZBotBotOSLeft,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZBotBotOSRight,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZTauTauOSLeft,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dZTauTauOSRight,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dBeta1KanUsual,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dBeta1KanAlter,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dBeta1PinchPStar,"\n')
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // "dBeta1PinchOS,"\n')
	electroweakCorrectionsFile.write("\t\t\tend if\n")
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthKanOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthKanChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthTadOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthTadChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthPStarOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthPStarChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthOSPinOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthOSPinChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthUsuProcDep1,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthAltProcDep1,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthUsuProcDep2,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthAltProcDep2,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthUsuProcDep3,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "WidthAltProcDep3,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthLO,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthKanOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthKanChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthTadOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthTadChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthPStarOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthPStarChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthOSPinOdd,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthOSPinChar,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthUsuProcDep1,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthAltProcDep1,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthUsuProcDep2,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthAltProcDep2,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthUsuProcDep3,"\n')
	electroweakCorrectionsFile.write('\t\t\toutputFileContent = trim(outputFileContent) // "DifWidthAltProcDep3\\n"\n\n')
	
	electroweakCorrectionsFile.write('\t\t\tdo point = 1, maxPoint, 1\n')
	electroweakCorrectionsFile.write('\t\t\t\t! Set the 2HDM parameters according to the current point in phase-space\n')
	electroweakCorrectionsFile.write('\t\t\t\tMHH = MHHList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tMA0 = MA0List(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tMHp = MHpList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tMHH = MHHList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\talpha = alphaList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tbeta = betaList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tCA = CAList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tSA = SAList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tTA = TAList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tCB = CBList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tSB = SBList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tTB = TBList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tS2A = S2AList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tC2A = C2AList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tS2B = S2BList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tC2B = C2BList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tCAB = CABList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tSAB = SABList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tCBA = CBAList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tSBA = SBAList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tYuk1 = Yuk1List(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tYuk2 = Yuk2List(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tYuk3 = Yuk3List(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tm12squared = m12squaredList(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tLambda5 = Lambda5List(point)\n')
	electroweakCorrectionsFile.write('\t\t\t\tTypeOf2HDM = TypeOf2HDMList(point)\n\n')
	...
	electroweakCorrectionsFile.write('\t\t\t\t! Calculate the square of the 2HDM input parameters\n')
	electroweakCorrectionsFile.write('\t\t\t\tMHH2 = MHH**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tMA02 = MA0**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tMHp2 = MHp**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tCA2 = CA**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tSA2 = SA**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tTA2 = TA**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tTB2 = TB**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tSB2 = SB**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tCB2 = CB**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tC2A2 = C2A**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tS2A2 = S2A**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tC2B2 = C2B**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tS2B2 = S2B**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tCAB2 = CAB**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tSAB2 = SAB**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tCBA2 = CBA**2\n')
	electroweakCorrectionsFile.write('\t\t\t\tSBA2 = SBA**2\n\n')
	...
	for x in range(0, len(processDescriptionList)):
		...
		electroweakCorrectionsFile.write('\t\t\t\t\tif (m1 .LE. 0D0) then\n')
	...
	electroweakCorrectionsFile.write('\t\t\t\t! Write the results to the output string\n')
	electroweakCorrectionsFile.write('\t\t\t\t! Format: we use 18 characters in total for double precision. 3 are reserved for the exponent, 1 for the sign of the exponent,\n')
	electroweakCorrectionsFile.write('\t\t\t\t! 1 for the symbol E denoting the exponent, 1 for the dot, 1 for a possible negative sign, 1 for the digit before the comma\n')
	electroweakCorrectionsFile.write('\t\t\t\t! and 10 for the digits after the comma\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) MHH\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) Mh0\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) MA0\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) MHp\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) alpha\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) beta\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) m12squared\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) Lambda5\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(I1)' ) TypeOf2HDM\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) InputScale\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) treeLevelWidth\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write('\t\t\t\tif (debugModeOn) then\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) NLOVCwidth\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) NLOVCwoIRwidth\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) NLOIRonlywidth\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMW2Usual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMW2Alter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMZ2Usual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMZ2Alter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMLOSUsual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMLOSAlter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMBOSUsual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dMBOSAlter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZHHHHOS()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZHHh0OSUsual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZHHh0OSAlter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZh0HHOSUsual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZh0HHOSAlter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZh0h0OS()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZA0A0OS()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZG0A0OSUsual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZG0A0OSAlter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZTauTauOSLeft()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZTauTauOSRight()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZBBOSLeft()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dZBBOSRight()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dBeta1KanUsual()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dBeta1KanAlter()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dBeta1PinchPStar()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)' ) dBeta1PinchOS()\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write('\t\t\t\tend if\n')
	electroweakCorrectionsFile.write('\t\t\t\tdo m = 1, maxNumberSchemes, 1\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)') NLOWidth(m)\n")
	electroweakCorrectionsFile.write('\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write('\t\t\t\tend do\n')
	electroweakCorrectionsFile.write("\t\t\t\twrite( tempVal, '(ES18.10E3)' ) ((treeLevelWidth - treeLevelWidth)*100D0/treeLevelWidth)\n")
	electroweakCorrectionsFile.write('\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write('\t\t\t\tdo m = 1, maxNumberSchemes, 1\n')
	electroweakCorrectionsFile.write("\t\t\t\t\twrite( tempVal, '(ES18.10E3)') ((NLOWidth(m) - treeLevelWidth)*100D0/treeLevelWidth)\n")
	electroweakCorrectionsFile.write('\t\t\t\t\tif (m == maxNumberSchemes) then\n')
	electroweakCorrectionsFile.write('\t\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // "\\n")\n')
	electroweakCorrectionsFile.write('\t\t\t\t\telse\n')
	electroweakCorrectionsFile.write('\t\t\t\t\t\toutputFileContent = trim(outputFileContent) // (trim(tempVal) // ",")\n')
	electroweakCorrectionsFile.write('\t\t\t\t\tend if\n')
	...
	electroweakCorrectionsFile.write("\t\t\topen(unit=44, file=trim(pathToOutputFiles)//trim(targetName), status='new', &\n")
