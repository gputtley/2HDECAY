...
def createElectroweakCorrections():
	...
	for x in range(0, len(processDescriptionList)):
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaProcDep1Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaProcDep1Usual()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaProcDep2Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaProcDep2Usual()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\talphaDistr = dAlphaProcDep3Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\t\tbetaDistr = dBetaProcDep3Usual()\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(9) = alphaOrig + alphaDistr - dAlphaProcDep1Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(10) = alphaOrig + alphaDistr - dAlphaProcDep1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(11) = alphaOrig + alphaDistr - dAlphaProcDep2Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(12) = alphaOrig + alphaDistr - dAlphaProcDep2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(13) = alphaOrig + alphaDistr - dAlphaProcDep3Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\talphaScheme(14) = alphaOrig + alphaDistr - dAlphaProcDep3Alter()\n\n')
		...
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(9) = betaOrig + betaDistr - dBetaProcDep1Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(10) = betaOrig + betaDistr - dBetaProcDep1Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(11) = betaOrig + betaDistr - dBetaProcDep2Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(12) = betaOrig + betaDistr - dBetaProcDep2Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(13) = betaOrig + betaDistr - dBetaProcDep3Usual()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\t\tbetaScheme(14) = betaOrig + betaDistr - dBetaProcDep3Alter()\n')
		electroweakCorrectionsFile.write('\t\t\t\t\t\tend if\n\n')
