...
#include "looptools.h"
 ...
 amplitudes(4) = (0.015625D0*CKM12*CKMC13*EL2*(MB*MS*B0(x, MU2, MW2) + MB*MS*MU2*DB0(x, MU2, MW2) - 1.D0*MB*MS*MW2*DB0(x, MU2, MW&
  &2) + MB*MS*x*DB0(x, MU2, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*CKM12*CKMC13*EL2*(-1.D0*MB*MS*A0(MU2) + MB*MS*A0(MW2) + MB*MS*MU&
  &2*B0(x, MU2, MW2) - 1.D0*MB*MS*MW2*B0(x, MU2, MW2) + MB*MS*x*B0(x, MU2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(5) = (0.015625D0*CKM22*CKMC23*EL2*(MB*MS*B0(x, MC2, MW2) + MB*MC2*MS*DB0(x, MC2, MW2) - 1.D0*MB*MS*MW2*DB0(x, MC2, MW&
  &2) + MB*MS*x*DB0(x, MC2, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*CKM22*CKMC23*EL2*(-1.D0*MB*MS*A0(MC2) + MB*MS*A0(MW2) + MB*MC2*M&
  &S*B0(x, MC2, MW2) - 1.D0*MB*MS*MW2*B0(x, MC2, MW2) + MB*MS*x*B0(x, MC2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(6) = (0.015625D0*CKM32*CKMC33*EL2*(MB*MS*B0(x, MT2, MW2) + MB*MS*MT2*DB0(x, MT2, MW2) - 1.D0*MB*MS*MW2*DB0(x, MT2, MW&
  &2) + MB*MS*x*DB0(x, MT2, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*CKM32*CKMC33*EL2*(-1.D0*MB*MS*A0(MT2) + MB*MS*A0(MW2) + MB*MS*MT&
  &2*B0(x, MT2, MW2) - 1.D0*MB*MS*MW2*B0(x, MT2, MW2) + MB*MS*x*B0(x, MT2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)
