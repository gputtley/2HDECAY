...
#include "looptools.h"
 ...
 amplitudes(4) = (-0.015625D0*EL2*MM2*DB0(x, MM2, MZ2))/(MW2*PI2*SW2)

 amplitudes(5) = 0.D0

 amplitudes(6) = 0.D0

 amplitudes(7) = (-0.25D0*EL2*DB0(x, 0.D0, MM2))/PI2

 amplitudes(8) = (-0.125D0*EL2*(-1.D0 + 2.D0*SW2)*DB0(x, MM2, MZ2))/(CW2*PI2)
