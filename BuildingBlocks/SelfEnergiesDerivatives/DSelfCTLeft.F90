...
#include "looptools.h"
 ...
 amplitudes(4) = (0.015625D0*CKM31*CKMC21*EL2*(MD2*B0(x, MD2, MW2) - 1.D0*MD2*MW2*DB0(x, MD2, MW2) + MD2*x*DB0(x, MD2, MW2) + DB0&
  &(x, MD2, MW2)*DBLE(MD**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM31*CKMC21*EL2*(-1.D0*MD2*A0(MD2) + MD2*A0(MW2) - 1.D0*MD2&
  &*MW2*B0(x, MD2, MW2) + MD2*x*B0(x, MD2, MW2) + B0(x, MD2, MW2)*DBLE(MD**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(5) = (0.015625D0*CKM32*CKMC22*EL2*(MS2*B0(x, MS2, MW2) - 1.D0*MS2*MW2*DB0(x, MS2, MW2) + MS2*x*DB0(x, MS2, MW2) + DB0&
  &(x, MS2, MW2)*DBLE(MS**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM32*CKMC22*EL2*(-1.D0*MS2*A0(MS2) + MS2*A0(MW2) - 1.D0*MS2&
  &*MW2*B0(x, MS2, MW2) + MS2*x*B0(x, MS2, MW2) + B0(x, MS2, MW2)*DBLE(MS**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(6) = (0.015625D0*CKM33*CKMC23*EL2*(MB2*B0(x, MB2, MW2) - 1.D0*MB2*MW2*DB0(x, MB2, MW2) + MB2*x*DB0(x, MB2, MW2) + DB0&
  &(x, MB2, MW2)*DBLE(MB**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM33*CKMC23*EL2*(-1.D0*MB2*A0(MB2) + MB2*A0(MW2) - 1.D0*MB2&
  &*MW2*B0(x, MB2, MW2) + MB2*x*B0(x, MB2, MW2) + B0(x, MB2, MW2)*DBLE(MB**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(7) = (0.03125D0*CKM31*CKMC21*EL2*(-1.D0 + B0(x, MD2, MW2) + MD2*DB0(x, MD2, MW2) - 1.D0*MW2*DB0(x, MD2, MW2) + x*DB0(&
  &x, MD2, MW2)))/(PI2*SW2*x) - (0.03125D0*CKM31*CKMC21*EL2*(-1.D0*x - 1.D0*A0(MD2) + A0(MW2) + MD2*B0(x, MD2, MW2) - 1.D0*MW2*B0&
  &(x, MD2, MW2) + x*B0(x, MD2, MW2))* DBLE(x**INT(-2.D0)))/(PI2*SW2)

 amplitudes(8) = (0.03125D0*CKM32*CKMC22*EL2*(-1.D0 + B0(x, MS2, MW2) + MS2*DB0(x, MS2, MW2) - 1.D0*MW2*DB0(x, MS2, MW2) + x*DB0(&
  &x, MS2, MW2)))/(PI2*SW2*x) - (0.03125D0*CKM32*CKMC22*EL2*(-1.D0*x - 1.D0*A0(MS2) + A0(MW2) + MS2*B0(x, MS2, MW2) - 1.D0*MW2*B0&
  &(x, MS2, MW2) + x*B0(x, MS2, MW2))* DBLE(x**INT(-2.D0)))/(PI2*SW2)

 amplitudes(9) = (0.03125D0*CKM33*CKMC23*EL2*(-1.D0 + B0(x, MB2, MW2) + MB2*DB0(x, MB2, MW2) - 1.D0*MW2*DB0(x, MB2, MW2) + x*DB0(&
  &x, MB2, MW2)))/(PI2*SW2*x) - (0.03125D0*CKM33*CKMC23*EL2*(-1.D0*x - 1.D0*A0(MB2) + A0(MW2) + MB2*B0(x, MB2, MW2) - 1.D0*MW2*B0&
