...
#include "looptools.h"
 ...
 amplitudes(4) = (0.015625D0*CKM12*CKMC13*EL2*(MU2*B0(x, MU2, MW2) - 1.D0*MU2*MW2*DB0(x, MU2, MW2) + MU2*x*DB0(x, MU2, MW2) + DB0&
  &(x, MU2, MW2)*DBLE(MU**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM12*CKMC13*EL2*(-1.D0*MU2*A0(MU2) + MU2*A0(MW2) - 1.D0*MU2&
  &*MW2*B0(x, MU2, MW2) + MU2*x*B0(x, MU2, MW2) + B0(x, MU2, MW2)*DBLE(MU**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(5) = (0.015625D0*CKM22*CKMC23*EL2*(MC2*B0(x, MC2, MW2) - 1.D0*MC2*MW2*DB0(x, MC2, MW2) + MC2*x*DB0(x, MC2, MW2) + DB0&
  &(x, MC2, MW2)*DBLE(MC**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM22*CKMC23*EL2*(-1.D0*MC2*A0(MC2) + MC2*A0(MW2) - 1.D0*MC2&
  &*MW2*B0(x, MC2, MW2) + MC2*x*B0(x, MC2, MW2) + B0(x, MC2, MW2)*DBLE(MC**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(6) = (0.015625D0*CKM32*CKMC33*EL2*(MT2*B0(x, MT2, MW2) - 1.D0*MT2*MW2*DB0(x, MT2, MW2) + MT2*x*DB0(x, MT2, MW2) + DB0&
  &(x, MT2, MW2)*DBLE(MT**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM32*CKMC33*EL2*(-1.D0*MT2*A0(MT2) + MT2*A0(MW2) - 1.D0*MT2&
