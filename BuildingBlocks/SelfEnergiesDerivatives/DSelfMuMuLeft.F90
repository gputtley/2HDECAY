...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*EL2*(-1.D0 + 4.D0*SW2 + B0(x, MM2, MZ2) - 4.D0*SW2*B0(x, MM2, MZ2) + MM2*DB0(x, MM2, MZ2) - 1.D0*MZ2&
  &*DB0(x, MM2, MZ2) - 4.D0*MM2*SW2*DB0(x, MM2, MZ2) + 4.D0*MZ2*SW2*DB0(x, MM2, MZ2) + x*DB0(x, MM2, MZ2) - 4.D0*SW2*x*DB0(x, MM2&
  &, MZ2) - 4.D0*DBLE(SW**INT(4.D0)) + 4.D0*B0(x, MM2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MM2*DB0(x, MM2, MZ2)*DBLE(SW**INT(4.D0)) -&
  & 4.D0*MZ2*DB0(x, MM2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*x*DB0(x, MM2, MZ2)*DBLE(SW**INT(4.D0))))/(CW2*PI2*SW2*x) - (0.015625D0*E&
  &L2*(-1.D0*x + 4.D0*SW2*x - 1.D0*A0(MM2) + 4.D0*SW2*A0(MM2) + A0(MZ2) - 4.D0*SW2*A0(MZ2) + MM2*B0(x, MM2, MZ2) - 1.D0*MZ2*B0(x,&
  & MM2, MZ2) - 4.D0*MM2*SW2*B0(x, MM2, MZ2) + 4.D0*MZ2*SW2*B0(x, MM2, MZ2) + x*B0(x, MM2, MZ2) - 4.D0*SW2*x*B0(x, MM2, MZ2) - 4.&
  &D0*x*DBLE(SW**INT(4.D0)) - 4.D0*A0(MM2)*DBLE(SW**INT(4.D0)) + 4.D0*A0(MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MM2*B0(x, MM2, MZ2)*DBLE&
  &(SW**INT(4.D0)) - 4.D0*MZ2*B0(x, MM2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*x*B0(x, MM2, MZ2)*DBLE(SW**INT(4.D0)))*DBLE(x**INT(-2.D0&
  &)))/(CW2*PI2*SW2)
