...
#include "looptools.h"
 ...
 amplitudes(6) = (0.015625D0*EL2*ML2*(B0(x, 0.D0, MW2) + (-1.D0*MW2 + x)*DB0(x, 0.D0, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*EL2*ML&
 ...
 amplitudes(8) = (0.015625D0*EL2*(-4.D0*DBLE(SW**INT(4.D0)) + 4.D0*B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*ML2*DB0(x, ML2, MZ2&
