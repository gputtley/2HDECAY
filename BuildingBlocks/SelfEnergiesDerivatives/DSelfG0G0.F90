...
#include "looptools.h"
 ...
 amplitudes(20) = (0.015625D0*EL2*SBA2*DB0(x, Mh02, MZ2)*DBLE(Mh0**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(21) = (0.015625D0*CBA2*EL2*DB0(x, MHH2, MZ2)*DBLE(MHH**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(22) = (0.015625D0*EL2*MW2*DB0(x, MW2, MW2))/(PI2*SW2)

 amplitudes(23) = (0.015625D0*EL2*MW2*DB0(x, MW2, MW2))/(PI2*SW2)

 amplitudes(24) = (0.015625D0*EL2*SBA2*(-2.D0*B0(x, Mh02, MZ2) + (-2.D0*Mh02 + MZ2 - 2.D0*x)*DB0(x, Mh02, MZ2)))/(CW2*PI2*SW2)

 amplitudes(25) = (0.015625D0*CBA2*EL2*(-2.D0*B0(x, MHH2, MZ2) + (-2.D0*MHH2 + MZ2 - 2.D0*x)*DB0(x, MHH2, MZ2)))/(CW2*PI2*SW2)

 amplitudes(26) = (-0.015625D0*EL2*(2.D0*B0(x, MW2, MW2) + (MW2 + 2.D0*x)*DB0(x, MW2, MW2)))/(PI2*SW2)

 amplitudes(27) = (-0.015625D0*EL2*(2.D0*B0(x, MW2, MW2) + (MW2 + 2.D0*x)*DB0(x, MW2, MW2)))/(PI2*SW2)
