...
#include "looptools.h"
 ...
 amplitudes(83) = (0.015625D0*EL2*ML2*(B0(x, 0.D0, MW2) + (-1.D0*MW2 + x)*DB0(x, 0.D0, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*EL2*M&
  &L2*(A0(MW2) + (-1.D0*MW2 + x)*B0(x, 0.D0, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(84) = (0.015625D0*EL2*(-4.D0*DBLE(SW**INT(4.D0)) + 4.D0*B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*ML2*DB0(x, ML2, MZ&
  &2)*DBLE(SW**INT(4.D0)) - 4.D0*MZ2*DB0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*x*DB0(x, ML2, MZ2)*DBLE(SW**INT(4.D0))))/(CW2*PI&
  &2*SW2*x) - (0.015625D0*EL2*(-4.D0*x*DBLE(SW**INT(4.D0)) - 4.D0*A0(ML2)*DBLE(SW**INT(4.D0)) + 4.D0*A0(MZ2)*DBLE(SW**INT(4.D0)) &
