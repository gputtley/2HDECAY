...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*CKM21*CKMC21*EL2*(MD2*B0(x, MD2, MW2) - 1.D0*MD2*MW2*DB0(x, MD2, MW2) + MD2*x*DB0(x, MD2, MW2) + DB0&
  &(x, MD2, MW2)*DBLE(MD**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM21*CKMC21*EL2*(-1.D0*MD2*A0(MD2) + MD2*A0(MW2) - 1.D0*MD2&
  &*MW2*B0(x, MD2, MW2) + MD2*x*B0(x, MD2, MW2) + B0(x, MD2, MW2)*DBLE(MD**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(9) = (0.015625D0*CKM22*CKMC22*EL2*(MS2*B0(x, MS2, MW2) - 1.D0*MS2*MW2*DB0(x, MS2, MW2) + MS2*x*DB0(x, MS2, MW2) + DB0&
  &(x, MS2, MW2)*DBLE(MS**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM22*CKMC22*EL2*(-1.D0*MS2*A0(MS2) + MS2*A0(MW2) - 1.D0*MS2&
  &*MW2*B0(x, MS2, MW2) + MS2*x*B0(x, MS2, MW2) + B0(x, MS2, MW2)*DBLE(MS**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(10) = (0.015625D0*CKM23*CKMC23*EL2*(MB2*B0(x, MB2, MW2) - 1.D0*MB2*MW2*DB0(x, MB2, MW2) + MB2*x*DB0(x, MB2, MW2) + DB&
  &0(x, MB2, MW2)*DBLE(MB**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM23*CKMC23*EL2*(-1.D0*MB2*A0(MB2) + MB2*A0(MW2) - 1.D0*MB&
 ...
 amplitudes(12) = (0.001736111111111111D0*EL2*(-9.D0 + 24.D0*SW2 + 9.D0*B0(x, MC2, MZ2) - 24.D0*SW2*B0(x, MC2, MZ2) + 9.D0*MC2*DB&
  &0(x, MC2, MZ2) - 9.D0*MZ2*DB0(x, MC2, MZ2) - 24.D0*MC2*SW2*DB0(x, MC2, MZ2) + 24.D0*MZ2*SW2*DB0(x, MC2, MZ2) + 9.D0*x*DB0(x, M&
  &C2, MZ2) - 24.D0*SW2*x*DB0(x, MC2, MZ2) - 16.D0*DBLE(SW**INT(4.D0)) + 16.D0*B0(x, MC2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MC2*DB&
  &0(x, MC2, MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*MZ2*DB0(x, MC2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*x*DB0(x, MC2, MZ2)*DBLE(SW**INT(4.&
  &D0))))/ (CW2*PI2*SW2*x) - (0.001736111111111111D0*EL2*(-9.D0*x + 24.D0*SW2*x - 9.D0*A0(MC2) + 24.D0*SW2*A0(MC2) + 9.D0*A0(MZ2)&
  & - 24.D0*SW2*A0(MZ2) + 9.D0*MC2*B0(x, MC2, MZ2) - 9.D0*MZ2*B0(x, MC2, MZ2) - 24.D0*MC2*SW2*B0(x, MC2, MZ2) + 24.D0*MZ2*SW2*B0(&
  &x, MC2, MZ2) + 9.D0*x*B0(x, MC2, MZ2) - 24.D0*SW2*x*B0(x, MC2, MZ2) - 16.D0*x*DBLE(SW**INT(4.D0)) - 16.D0*A0(MC2)*DBLE(SW**INT&
  &(4.D0)) + 16.D0*A0(MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MC2*B0(x, MC2, MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*MZ2*B0(x, MC2, MZ2)*DBLE(S&
  &W**INT(4.D0)) + 16.D0*x*B0(x, MC2, MZ2)*DBLE(SW**INT(4.D0)))* DBLE(x**INT(-2.D0)))/(CW2*PI2*SW2)

 amplitudes(13) = (0.03125D0*CKM21*CKMC21*EL2*(-1.D0 + B0(x, MD2, MW2) + MD2*DB0(x, MD2, MW2) - 1.D0*MW2*DB0(x, MD2, MW2) + x*DB0&
  &(x, MD2, MW2)))/(PI2*SW2*x) - (0.03125D0*CKM21*CKMC21*EL2*(-1.D0*x - 1.D0*A0(MD2) + A0(MW2) + MD2*B0(x, MD2, MW2) - 1.D0*MW2*B&
  &0(x, MD2, MW2) + x*B0(x, MD2, MW2))* DBLE(x**INT(-2.D0)))/(PI2*SW2)

 amplitudes(14) = (0.03125D0*CKM22*CKMC22*EL2*(-1.D0 + B0(x, MS2, MW2) + MS2*DB0(x, MS2, MW2) - 1.D0*MW2*DB0(x, MS2, MW2) + x*DB0&
  &(x, MS2, MW2)))/(PI2*SW2*x) - (0.03125D0*CKM22*CKMC22*EL2*(-1.D0*x - 1.D0*A0(MS2) + A0(MW2) + MS2*B0(x, MS2, MW2) - 1.D0*MW2*B&
  &0(x, MS2, MW2) + x*B0(x, MS2, MW2))* DBLE(x**INT(-2.D0)))/(PI2*SW2)

 amplitudes(15) = (0.03125D0*CKM23*CKMC23*EL2*(-1.D0 + B0(x, MB2, MW2) + MB2*DB0(x, MB2, MW2) - 1.D0*MW2*DB0(x, MB2, MW2) + x*DB0&
  &(x, MB2, MW2)))/(PI2*SW2*x) - (0.03125D0*CKM23*CKMC23*EL2*(-1.D0*x - 1.D0*A0(MB2) + A0(MW2) + MB2*B0(x, MB2, MW2) - 1.D0*MW2*B&
