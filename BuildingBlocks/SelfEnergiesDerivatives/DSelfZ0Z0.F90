...
#include "looptools.h"
 ...
 amplitudes(22) = (-0.001736111111111111D0*EL2*SBA2*DBLE(x**INT(-2.D0))*(-6.D0*Mh02*x - 6.D0*MZ2*x - 3.D0*(Mh02 - 1.D0*MZ2 + x)*A&
  &0(Mh02) + 3.D0*(Mh02 - 1.D0*MZ2 - 1.D0*x)*A0(MZ2) - 6.D0*Mh02*MZ2*B0(x, Mh02, MZ2) - 6.D0*Mh02*x*B0(x, Mh02, MZ2) - 6.D0*MZ2*x&
  &*B0(x, Mh02, MZ2) + 3.D0*B0(x, Mh02, MZ2)*DBLE(Mh0**INT(4.D0)) + 3.D0*B0(x, Mh02, MZ2)*DBLE(MZ**INT(4.D0)) + 2.D0*DBLE(x**INT(&
  &2.D0)) + 3.D0*B0(x, Mh02, MZ2)*DBLE(x**INT(2.D0))))/(CW2*PI2*SW2) + (0.001736111111111111D0*EL2*SBA2*(-6.D0*Mh02 - 6.D0*MZ2 + &
  &4.D0*x - 3.D0*A0(Mh02) - 3.D0*A0(MZ2) - 6.D0*Mh02*B0(x, Mh02, MZ2) - 6.D0*MZ2*B0(x, Mh02, MZ2) + 6.D0*x*B0(x, Mh02, MZ2) - 6.D&
  &0*Mh02*MZ2*DB0(x, Mh02, MZ2) - 6.D0*Mh02*x*DB0(x, Mh02, MZ2) - 6.D0*MZ2*x*DB0(x, Mh02, MZ2) + 3.D0*DB0(x, Mh02, MZ2)*DBLE(Mh0*&
  &*INT(4.D0)) + 3.D0*DB0(x, Mh02, MZ2)*DBLE(MZ**INT(4.D0)) + 3.D0*DB0(x, Mh02, MZ2)*DBLE(x**INT(2.D0))))/(CW2*PI2*SW2*x)

 amplitudes(23) = (-0.001736111111111111D0*CBA2*EL2*DBLE(x**INT(-2.D0))*(-6.D0*MHH2*x - 6.D0*MZ2*x - 3.D0*(MHH2 - 1.D0*MZ2 + x)*A&
  &0(MHH2) + 3.D0*(MHH2 - 1.D0*MZ2 - 1.D0*x)*A0(MZ2) - 6.D0*MHH2*MZ2*B0(x, MHH2, MZ2) - 6.D0*MHH2*x*B0(x, MHH2, MZ2) - 6.D0*MZ2*x&
  &*B0(x, MHH2, MZ2) + 3.D0*B0(x, MHH2, MZ2)*DBLE(MHH**INT(4.D0)) + 3.D0*B0(x, MHH2, MZ2)*DBLE(MZ**INT(4.D0)) + 2.D0*DBLE(x**INT(&
  &2.D0)) + 3.D0*B0(x, MHH2, MZ2)*DBLE(x**INT(2.D0))))/(CW2*PI2*SW2) + (0.001736111111111111D0*CBA2*EL2*(-6.D0*MHH2 - 6.D0*MZ2 + &
  &4.D0*x - 3.D0*A0(MHH2) - 3.D0*A0(MZ2) - 6.D0*MHH2*B0(x, MHH2, MZ2) - 6.D0*MZ2*B0(x, MHH2, MZ2) + 6.D0*x*B0(x, MHH2, MZ2) - 6.D&
  &0*MHH2*MZ2*DB0(x, MHH2, MZ2) - 6.D0*MHH2*x*DB0(x, MHH2, MZ2) - 6.D0*MZ2*x*DB0(x, MHH2, MZ2) + 3.D0*DB0(x, MHH2, MZ2)*DBLE(MHH*&
  &*INT(4.D0)) + 3.D0*DB0(x, MHH2, MZ2)*DBLE(MZ**INT(4.D0)) + 3.D0*DB0(x, MHH2, MZ2)*DBLE(x**INT(2.D0))))/(CW2*PI2*SW2*x)
 ...
 amplitudes(25) = (-0.001736111111111111D0*EL2*(-2.D0 - 3.D0*B0(x, MW2, MW2) + 3.D0*(4.D0*MW2 - 1.D0*x)*DB0(x, MW2, MW2))*DBLE((C&
  &W2 - 1.D0*SW2)**INT(2.D0)))/(CW2*PI2*SW2)

 amplitudes(26) = (0.001736111111111111D0*CW2*EL2*(-2.D0 - 3.D0*B0(x, MW2, MW2) + 3.D0*(4.D0*MW2 - 1.D0*x)*DB0(x, MW2, MW2)))/(PI&
  &2*SW2)

 amplitudes(27) = (0.001736111111111111D0*CW2*EL2*(-2.D0 - 3.D0*B0(x, MW2, MW2) + 3.D0*(4.D0*MW2 - 1.D0*x)*DB0(x, MW2, MW2)))/(PI&
  &2*SW2)

 amplitudes(28) = (-0.003472222222222222D0*CW2*EL2*(2.D0 + 57.D0*B0(x, MW2, MW2) + (96.D0*MW2 + 57.D0*x)*DB0(x, MW2, MW2)))/(PI2*&
  &SW2)

 amplitudes(29) = (0.0625D0*EL2*MW2*SBA2*DB0(x, Mh02, MZ2)*DBLE(CW**INT(-4.D0)))/(PI2*SW2)

 amplitudes(30) = (0.0625D0*CBA2*EL2*MW2*DB0(x, MHH2, MZ2)*DBLE(CW**INT(-4.D0)))/(PI2*SW2)

 amplitudes(31) = (0.0625D0*EL2*MW2*SW2*DB0(x, MW2, MW2))/(CW2*PI2)

 amplitudes(32) = (0.0625D0*EL2*MW2*SW2*DB0(x, MW2, MW2))/(CW2*PI2)
