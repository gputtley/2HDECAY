...
#include "looptools.h"
 ...
 amplitudes(4) = (0.015625D0*CKM11*CKMC13*EL2*(MB*MD*B0(x, MU2, MW2) + MB*MD*MU2*DB0(x, MU2, MW2) - 1.D0*MB*MD*MW2*DB0(x, MU2, MW&
  &2) + MB*MD*x*DB0(x, MU2, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*CKM11*CKMC13*EL2*(-1.D0*MB*MD*A0(MU2) + MB*MD*A0(MW2) + MB*MD*MU&
  &2*B0(x, MU2, MW2) - 1.D0*MB*MD*MW2*B0(x, MU2, MW2) + MB*MD*x*B0(x, MU2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(5) = (0.015625D0*CKM21*CKMC23*EL2*(MB*MD*B0(x, MC2, MW2) + MB*MC2*MD*DB0(x, MC2, MW2) - 1.D0*MB*MD*MW2*DB0(x, MC2, MW&
  &2) + MB*MD*x*DB0(x, MC2, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*CKM21*CKMC23*EL2*(-1.D0*MB*MD*A0(MC2) + MB*MD*A0(MW2) + MB*MC2*M&
  &D*B0(x, MC2, MW2) - 1.D0*MB*MD*MW2*B0(x, MC2, MW2) + MB*MD*x*B0(x, MC2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(6) = (0.015625D0*CKM31*CKMC33*EL2*(MB*MD*B0(x, MT2, MW2) + MB*MD*MT2*DB0(x, MT2, MW2) - 1.D0*MB*MD*MW2*DB0(x, MT2, MW&
  &2) + MB*MD*x*DB0(x, MT2, MW2)))/(MW2*PI2*SW2*x) - (0.015625D0*CKM31*CKMC33*EL2*(-1.D0*MB*MD*A0(MT2) + MB*MD*A0(MW2) + MB*MD*MT&
  &2*B0(x, MT2, MW2) - 1.D0*MB*MD*MW2*B0(x, MT2, MW2) + MB*MD*x*B0(x, MT2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)
