...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*CKM31*CKMC31*EL2*(MT2*B0(x, MD2, MW2) + MD2*MT2*DB0(x, MD2, MW2) - 1.D0*MT2*MW2*DB0(x, MD2, MW2) + M&
  &T2*x*DB0(x, MD2, MW2)))/ (MW2*PI2*SW2*x) - (0.015625D0*CKM31*CKMC31*EL2*(-1.D0*MT2*A0(MD2) + MT2*A0(MW2) + MD2*MT2*B0(x, MD2, &
  &MW2) - 1.D0*MT2*MW2*B0(x, MD2, MW2) + MT2*x*B0(x, MD2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(9) = (0.015625D0*CKM32*CKMC32*EL2*(MT2*B0(x, MS2, MW2) + MS2*MT2*DB0(x, MS2, MW2) - 1.D0*MT2*MW2*DB0(x, MS2, MW2) + M&
  &T2*x*DB0(x, MS2, MW2)))/ (MW2*PI2*SW2*x) - (0.015625D0*CKM32*CKMC32*EL2*(-1.D0*MT2*A0(MS2) + MT2*A0(MW2) + MS2*MT2*B0(x, MS2, &
  &MW2) - 1.D0*MT2*MW2*B0(x, MS2, MW2) + MT2*x*B0(x, MS2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(10) = (0.015625D0*CKM33*CKMC33*EL2*(MT2*B0(x, MB2, MW2) + MB2*MT2*DB0(x, MB2, MW2) - 1.D0*MT2*MW2*DB0(x, MB2, MW2) + &
  &MT2*x*DB0(x, MB2, MW2)))/ (MW2*PI2*SW2*x) - (0.015625D0*CKM33*CKMC33*EL2*(-1.D0*MT2*A0(MB2) + MT2*A0(MW2) + MB2*MT2*B0(x, MB2,&
  & MW2) - 1.D0*MT2*MW2*B0(x, MB2, MW2) + MT2*x*B0(x, MB2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)
 ...
 amplitudes(12) = (0.001736111111111111D0*EL2*(-16.D0*DBLE(SW**INT(4.D0)) + 16.D0*B0(x, MT2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MT2&
