...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*CKM12*CKMC12*EL2*(MS2*B0(x, MU2, MW2) + MS2*MU2*DB0(x, MU2, MW2) - 1.D0*MS2*MW2*DB0(x, MU2, MW2) + M&
  &S2*x*DB0(x, MU2, MW2)))/ (MW2*PI2*SW2*x) - (0.015625D0*CKM12*CKMC12*EL2*(-1.D0*MS2*A0(MU2) + MS2*A0(MW2) + MS2*MU2*B0(x, MU2, &
  &MW2) - 1.D0*MS2*MW2*B0(x, MU2, MW2) + MS2*x*B0(x, MU2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(9) = (0.015625D0*CKM22*CKMC22*EL2*(MS2*B0(x, MC2, MW2) + MC2*MS2*DB0(x, MC2, MW2) - 1.D0*MS2*MW2*DB0(x, MC2, MW2) + M&
  &S2*x*DB0(x, MC2, MW2)))/ (MW2*PI2*SW2*x) - (0.015625D0*CKM22*CKMC22*EL2*(-1.D0*MS2*A0(MC2) + MS2*A0(MW2) + MC2*MS2*B0(x, MC2, &
  &MW2) - 1.D0*MS2*MW2*B0(x, MC2, MW2) + MS2*x*B0(x, MC2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)

 amplitudes(10) = (0.015625D0*CKM32*CKMC32*EL2*(MS2*B0(x, MT2, MW2) + MS2*MT2*DB0(x, MT2, MW2) - 1.D0*MS2*MW2*DB0(x, MT2, MW2) + &
  &MS2*x*DB0(x, MT2, MW2)))/ (MW2*PI2*SW2*x) - (0.015625D0*CKM32*CKMC32*EL2*(-1.D0*MS2*A0(MT2) + MS2*A0(MW2) + MS2*MT2*B0(x, MT2,&
  & MW2) - 1.D0*MS2*MW2*B0(x, MT2, MW2) + MS2*x*B0(x, MT2, MW2))*DBLE(x**INT(-2.D0)))/(MW2*PI2*SW2)
 ...
 amplitudes(12) = (0.001736111111111111D0*EL2*(-4.D0*DBLE(SW**INT(4.D0)) + 4.D0*B0(x, MS2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MS2*DB&
