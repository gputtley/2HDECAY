 ...
 select case (x)
	...
	case (8)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSAlter()/MB - dMW2Alter()/(2D0*MW2) + Yuk3*dBeta2PinchOS() + &
			...
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + MHH2)*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (9)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSUsual()/MB - dMW2Usual()/(2D0*MW2) + Yuk3*dBetaProcDep1Usual() + &
			& Yuk1/Yuk2*dAlphaProcDep1Usual() + dZHHHHOS()/2D0 + Yuk1/Yuk2*dZh0HHOSUsual()/2D0 + dZBBOSLeft()/2D0 + &
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + MHH2)*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (10)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSAlter()/MB - dMW2Alter()/(2D0*MW2) + Yuk3*dBetaProcDep1Alter() + &
			...
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + MHH2)*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (11)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSUsual()/MB - dMW2Usual()/(2D0*MW2) + Yuk3*dBetaProcDep2Usual() + &
			& Yuk1/Yuk2*dAlphaProcDep2Usual() + dZHHHHOS()/2D0 + Yuk1/Yuk2*dZh0HHOSUsual()/2D0 + dZBBOSLeft()/2D0 + &
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + MHH2)*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (12)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSAlter()/MB - dMW2Alter()/(2D0*MW2) + Yuk3*dBetaProcDep2Alter() + &
			...
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + MHH2)*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (13)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSUsual()/MB - dMW2Usual()/(2D0*MW2) + Yuk3*dBetaProcDep3Usual() + &
			& Yuk1/Yuk2*dAlphaProcDep3Usual() + dZHHHHOS()/2D0 + Yuk1/Yuk2*dZh0HHOSUsual()/2D0 + dZBBOSLeft()/2D0 + &
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + MHH2)*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (14)
