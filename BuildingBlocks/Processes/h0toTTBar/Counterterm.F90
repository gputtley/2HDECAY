 ...
 select case (x)
	...
	case (9)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSUsual()/MT - dMW2Usual()/(2D0*MW2) - dBetaProcDep1Usual()/TB - &
			& dAlphaProcDep1Usual()*TA + dZh0h0OS()/2D0 + SA/CA * dZHHh0OSUsual()/2D0 + dZTTOSLeft()/2D0 + &
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*CA2*(Mh02 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (10)
	...
	case (11)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSUsual()/MT - dMW2Usual()/(2D0*MW2) - dBetaProcDep2Usual()/TB - &
			& dAlphaProcDep2Usual()*TA + dZh0h0OS()/2D0 + SA/CA * dZHHh0OSUsual()/2D0 + dZTTOSLeft()/2D0 + &
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*CA2*(Mh02 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (12)
	...
	case (13)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSUsual()/MT - dMW2Usual()/(2D0*MW2) - dBetaProcDep3Usual()/TB - &
			& dAlphaProcDep3Usual()*TA + dZh0h0OS()/2D0 + SA/CA * dZHHh0OSUsual()/2D0 + dZTTOSLeft()/2D0 + &
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*CA2*(Mh02 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (14)
