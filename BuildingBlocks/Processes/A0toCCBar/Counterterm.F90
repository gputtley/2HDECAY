 ...
 select case (x)
	...
	case (8)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - 1D0/(SB*CB)*dBeta2PinchOS() + &
			...
			& (1.5D0*EL2*MA02*MC2)/(MW2*SW2*TB2)
	case (9)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - 1D0/(SB*CB)*dBetaProcDep1Usual() + &
			& dZA0A0OS()/2D0 + TB*dZG0A0OSUsual()/2D0 + dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 )*&
			& (1.5D0*EL2*MA02*MC2)/(MW2*SW2*TB2)
	case (10)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - 1D0/(SB*CB)*dBetaProcDep1Alter() + &
			...
			& (1.5D0*EL2*MA02*MC2)/(MW2*SW2*TB2)
	case (11)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - 1D0/(SB*CB)*dBetaProcDep2Usual() + &
			& dZA0A0OS()/2D0 + TB*dZG0A0OSUsual()/2D0 + dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 )*&
			& (1.5D0*EL2*MA02*MC2)/(MW2*SW2*TB2)
	case (12)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - 1D0/(SB*CB)*dBetaProcDep2Alter() + &
			...
			& (1.5D0*EL2*MA02*MC2)/(MW2*SW2*TB2)
	case (13)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - 1D0/(SB*CB)*dBetaProcDep3Usual() + &
			& dZA0A0OS()/2D0 + TB*dZG0A0OSUsual()/2D0 + dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 )*&
			& (1.5D0*EL2*MA02*MC2)/(MW2*SW2*TB2)
	case (14)
