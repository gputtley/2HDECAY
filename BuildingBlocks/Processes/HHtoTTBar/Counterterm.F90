 ...
 select case (x)
	...
	case (8)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSAlter()/MT - dMW2Alter()/(2D0*MW2) - dBeta2PinchOS()/TB + &
			...
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*SA2*(MHH2 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (9)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSUsual()/MT - dMW2Usual()/(2D0*MW2) - dBetaProcDep1Usual()/TB + &
			& dAlphaProcDep1Usual()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSUsual()/2D0 + dZTTOSLeft()/2D0 + &
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*SA2*(MHH2 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (10)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSAlter()/MT - dMW2Alter()/(2D0*MW2) - dBetaProcDep1Alter()/TB + &
			...
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*SA2*(MHH2 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (11)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSUsual()/MT - dMW2Usual()/(2D0*MW2) - dBetaProcDep2Usual()/TB + &
			& dAlphaProcDep2Usual()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSUsual()/2D0 + dZTTOSLeft()/2D0 + &
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*SA2*(MHH2 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (12)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSAlter()/MT - dMW2Alter()/(2D0*MW2) - dBetaProcDep2Alter()/TB + &
			...
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*SA2*(MHH2 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (13)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMTOSUsual()/MT - dMW2Usual()/(2D0*MW2) - dBetaProcDep3Usual()/TB + &
			& dAlphaProcDep3Usual()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSUsual()/2D0 + dZTTOSLeft()/2D0 + &
			& dZTTOSRight()/2D0 )*(1.5D0*EL2*MT2*SA2*(MHH2 - 4.D0*MT2))/(MW2*SB2*SW2)
	case (14)
