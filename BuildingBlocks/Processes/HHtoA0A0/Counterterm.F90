...
#include "looptools.h"
 ...
 select case (x)
	...
	case (9)
		...
		& EL/(2D0*MW*SW)*(&
		&	(2D0*SAB/S2B-CBA)*dMHH2OSUsual() + 2D0*CBA*dMA02OSUsual() - 4D0*MW2*SAB*SW2/(EL2*S2B)*Lambda5*(&
		&		2D0*dgAtMZ()/(EL/SW) - dMW2Usual()/MW2 - 2D0*C2B/S2B*dBetaProcDep1Usual() + EL2*dm122MSBarUsual()/(SW2*MW2*&
		&			S2B*Lambda5)&
		&		) + &
		&	(SBA*(2D0*MA02-MHH2) + CAB/S2B*(2D0*MHH2 - 4D0*SW2*MW2*Lambda5/EL2))*dAlphaProcDep1Usual() + &
		&	(-SBA*(2D0*MA02-MHH2) + (CAB/S2B - 2D0*SAB*C2B/(S2B**2))*(2D0*MHH2-4D0*MW2*SW2*Lambda5/EL2))*dBetaProcDep1Usual()&
		&	)&
		& )
	case (10)
		totalAmplitude = (0.25D0*EL2*DBLE((CBA*(2.D0*MA02 - 1.D0*MHH2) + (SAB*(2.D0*MHH2 - (4.D0*Lambda5*MW2*SW2)/EL2))/&
	...
	case (11)
		...
		& EL/(2D0*MW*SW)*(&
		&	(2D0*SAB/S2B-CBA)*dMHH2OSUsual() + 2D0*CBA*dMA02OSUsual() - 4D0*MW2*SAB*SW2/(EL2*S2B)*Lambda5*(&
		&		2D0*dgAtMZ()/(EL/SW) - dMW2Usual()/MW2 - 2D0*C2B/S2B*dBetaProcDep2Usual() + EL2*dm122MSBarUsual()/(SW2*MW2*&
		&			S2B*Lambda5)&
		&		) + &
		&	(SBA*(2D0*MA02-MHH2) + CAB/S2B*(2D0*MHH2 - 4D0*SW2*MW2*Lambda5/EL2))*dAlphaProcDep2Usual() + &
		&	(-SBA*(2D0*MA02-MHH2) + (CAB/S2B - 2D0*SAB*C2B/(S2B**2))*(2D0*MHH2-4D0*MW2*SW2*Lambda5/EL2))*dBetaProcDep2Usual()&
		&	)&
		& )
	case (12)
		totalAmplitude = (0.25D0*EL2*DBLE((CBA*(2.D0*MA02 - 1.D0*MHH2) + (SAB*(2.D0*MHH2 - (4.D0*Lambda5*MW2*SW2)/EL2))/&
	...
	case (13)
		...
		& EL/(2D0*MW*SW)*(&
		&	(2D0*SAB/S2B-CBA)*dMHH2OSUsual() + 2D0*CBA*dMA02OSUsual() - 4D0*MW2*SAB*SW2/(EL2*S2B)*Lambda5*(&
		&		2D0*dgAtMZ()/(EL/SW) - dMW2Usual()/MW2 - 2D0*C2B/S2B*dBetaProcDep3Usual() + EL2*dm122MSBarUsual()/(SW2*MW2*&
		&			S2B*Lambda5)&
		&		) + &
		&	(SBA*(2D0*MA02-MHH2) + CAB/S2B*(2D0*MHH2 - 4D0*SW2*MW2*Lambda5/EL2))*dAlphaProcDep3Usual() + &
		&	(-SBA*(2D0*MA02-MHH2) + (CAB/S2B - 2D0*SAB*C2B/(S2B**2))*(2D0*MHH2-4D0*MW2*SW2*Lambda5/EL2))*dBetaProcDep3Usual()&
		&	)&
		& )
	case (14)
		totalAmplitude = (0.25D0*EL2*DBLE((CBA*(2.D0*MA02 - 1.D0*MHH2) + (SAB*(2.D0*MHH2 - (4.D0*Lambda5*MW2*SW2)/EL2))/&
