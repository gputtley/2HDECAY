...
#include "looptools.h"
 ...
 select case (x)
	...
	case (9)
		...
		&/S2B)**INT(2.D0)))/(MW2*SW2)*( dZHHHHOS()/2D0 + dZHpHpOS() + dgAtMZ()/(EL/SW) - dMW2Usual()/(2D0*MW2) ) + &
		&(-(EL*(-(CBA*(MHH2 - 2*MHp2)) + (SAB*(2*MHH2 - (4*Lambda5*MW2*SW2)/EL2))/S2B))/(2*MW*SW))*(-EL/(2D0*MW*SW))*(&
			& CBA*(2D0*dMHp2OSUsual() - dMHH2OSUsual() ) - SBA*(dBeta1KanUsual() - dAlphaProcDep1Usual())*(2D0*MHp2 - MHH2) + &
			& SAB/S2B*(2D0*dMHH2OSUsual() - 4D0*dm122MSBarUsual()/S2B + 8D0*Lambda5*MW2*SW2*C2B*dBeta1KanUsual()/(S2B*EL2)) +&
			& (CAB/S2B*(dAlphaProcDep1Usual() + dBeta1KanUsual()) - 2D0*SAB*C2B/S2B**2*dBeta1KanUsual())*(2D0*MHH2 - &
			& 4D0*Lambda5*MW2*SW2/EL2) &
		&) + (-(EL*(-(CBA*(MHH2 - 2*MHp2)) + (SAB*(2*MHH2 - (4*Lambda5*MW2*SW2)/EL2))/S2B))/(2*MW*SW))*(&
			&(-EL*SBA/(2D0*MW*SW))*(MHp2 - MHH2)*dZGpHpOSUsual() + &
			&(EL/(2D0*MW*SW)*(SBA*(Mh02 - 2D0*MHp2) - CAB/S2B*(2D0*Mh02 - 4D0*Lambda5*MW2*SW2/EL2)))*dZh0HHOSUsual()/2D0 &
	...
	case (11)
		...
		&/S2B)**INT(2.D0)))/(MW2*SW2)*( dZHHHHOS()/2D0 + dZHpHpOS() + dgAtMZ()/(EL/SW) - dMW2Usual()/(2D0*MW2) ) + &
		&(-(EL*(-(CBA*(MHH2 - 2*MHp2)) + (SAB*(2*MHH2 - (4*Lambda5*MW2*SW2)/EL2))/S2B))/(2*MW*SW))*(-EL/(2D0*MW*SW))*(&
			& CBA*(2D0*dMHp2OSUsual() - dMHH2OSUsual() ) - SBA*(dBeta1KanUsual() - dAlphaProcDep2Usual())*(2D0*MHp2 - MHH2) + &
			& SAB/S2B*(2D0*dMHH2OSUsual() - 4D0*dm122MSBarUsual()/S2B + 8D0*Lambda5*MW2*SW2*C2B*dBeta1KanUsual()/(S2B*EL2)) +&
			& (CAB/S2B*(dAlphaProcDep2Usual() + dBeta1KanUsual()) - 2D0*SAB*C2B/S2B**2*dBeta1KanUsual())*(2D0*MHH2 - &
			& 4D0*Lambda5*MW2*SW2/EL2) &
		&) + (-(EL*(-(CBA*(MHH2 - 2*MHp2)) + (SAB*(2*MHH2 - (4*Lambda5*MW2*SW2)/EL2))/S2B))/(2*MW*SW))*(&
			&(-EL*SBA/(2D0*MW*SW))*(MHp2 - MHH2)*dZGpHpOSUsual() + &
			&(EL/(2D0*MW*SW)*(SBA*(Mh02 - 2D0*MHp2) - CAB/S2B*(2D0*Mh02 - 4D0*Lambda5*MW2*SW2/EL2)))*dZh0HHOSUsual()/2D0 &
	...
	case (13)
		...
		&/S2B)**INT(2.D0)))/(MW2*SW2)*( dZHHHHOS()/2D0 + dZHpHpOS() + dgAtMZ()/(EL/SW) - dMW2Usual()/(2D0*MW2) ) + &
		&(-(EL*(-(CBA*(MHH2 - 2*MHp2)) + (SAB*(2*MHH2 - (4*Lambda5*MW2*SW2)/EL2))/S2B))/(2*MW*SW))*(-EL/(2D0*MW*SW))*(&
			& CBA*(2D0*dMHp2OSUsual() - dMHH2OSUsual() ) - SBA*(dBetaProcDep3Usual() - dAlphaProcDep3Usual())*(2D0*MHp2 - MHH2) +&
			& SAB/S2B*(2D0*dMHH2OSUsual() - 4D0*dm122MSBarUsual()/S2B + 8D0*Lambda5*MW2*SW2*C2B*dBetaProcDep3Usual()/(S2B*EL2)&
			&)+ (CAB/S2B*(dAlphaProcDep3Usual() + dBetaProcDep3Usual()) - 2D0*SAB*C2B/S2B**2*dBetaProcDep3Usual())*(2D0*MHH2 - &
			& 4D0*Lambda5*MW2*SW2/EL2) &
		&) + (-(EL*(-(CBA*(MHH2 - 2*MHp2)) + (SAB*(2*MHH2 - (4*Lambda5*MW2*SW2)/EL2))/S2B))/(2*MW*SW))*(&
			&(-EL*SBA/(2D0*MW*SW))*(MHp2 - MHH2)*dZGpHpOSUsual() + &
			&(EL/(2D0*MW*SW)*(SBA*(Mh02 - 2D0*MHp2) - CAB/S2B*(2D0*Mh02 - 4D0*Lambda5*MW2*SW2/EL2)))*dZh0HHOSUsual()/2D0 &
