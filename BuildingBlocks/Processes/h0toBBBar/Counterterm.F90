 ...
 select case (x)
	...
	case (9)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSUsual()/MB - dMW2Usual()/(2D0*MW2) + Yuk3*dBetaProcDep1Usual() - &
			& Yuk2/Yuk1*dAlphaProcDep1Usual() + dZh0h0OS()/2D0 + Yuk2/Yuk1*dZHHh0OSUsual()/2D0 + dZBBOSLeft()/2D0 + &
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + Mh02)*DBLE(Yuk1**INT(2.D0)))/(MW2*SW2)
	case (10)
	...
	case (11)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSUsual()/MB - dMW2Usual()/(2D0*MW2) + Yuk3*dBetaProcDep2Usual() - &
			& Yuk2/Yuk1*dAlphaProcDep2Usual() + dZh0h0OS()/2D0 + Yuk2/Yuk1*dZHHh0OSUsual()/2D0 + dZBBOSLeft()/2D0 + &
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + Mh02)*DBLE(Yuk1**INT(2.D0)))/(MW2*SW2)
	case (12)
	...
	case (13)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMBOSUsual()/MB - dMW2Usual()/(2D0*MW2) + Yuk3*dBetaProcDep3Usual() - &
			& Yuk2/Yuk1*dAlphaProcDep3Usual() + dZh0h0OS()/2D0 + Yuk2/Yuk1*dZHHh0OSUsual()/2D0 + dZBBOSLeft()/2D0 + &
			& dZBBOSRight()/2D0 )*(1.5D0*EL2*MB2*(-4.D0*MB2 + Mh02)*DBLE(Yuk1**INT(2.D0)))/(MW2*SW2)
	case (14)
