...
#include "looptools.h"
 ...
 select case (x)
    ...
    case (9)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + dMW2Usual()/(2D0*MW2) + dZh0h0OS()/2D0 + dZWpWpOS() + &
            & CBA/SBA*(dZHHh0OSUsual()/2D0 - dAlphaProcDep1Usual() + dBetaProcDep1Usual()) ) * (EL2/SW2)*SBA2*MW2 * &
            & (3D0 + Mh02**2/(4D0*MW2**2) - Mh02/MW2)
    case (10)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + dMW2Alter()/(2D0*MW2) + dZh0h0OS()/2D0 + dZWpWpOS() + &
    ...
    case (11)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + dMW2Usual()/(2D0*MW2) + dZh0h0OS()/2D0 + dZWpWpOS() + &
            & CBA/SBA*(dZHHh0OSUsual()/2D0 - dAlphaProcDep2Usual() + dBetaProcDep2Usual()) ) * (EL2/SW2)*SBA2*MW2 * &
            & (3D0 + Mh02**2/(4D0*MW2**2) - Mh02/MW2)
    case (12)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + dMW2Alter()/(2D0*MW2) + dZh0h0OS()/2D0 + dZWpWpOS() + &
    ...
    case (13)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + dMW2Usual()/(2D0*MW2) + dZh0h0OS()/2D0 + dZWpWpOS() + &
            & CBA/SBA*(dZHHh0OSUsual()/2D0 - dAlphaProcDep2Usual() + dBetaProcDep3Usual()) ) * (EL2/SW2)*SBA2*MW2 * &
            & (3D0 + Mh02**2/(4D0*MW2**2) - Mh02/MW2)
    case (14)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + dMW2Alter()/(2D0*MW2) + dZh0h0OS()/2D0 + dZWpWpOS() + &
