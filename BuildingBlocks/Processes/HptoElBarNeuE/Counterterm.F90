...
#include "looptools.h"
 ...
 select case (x)
	...
	case (9)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSUsual()/ME - dMW2Usual()/(2D0*MW2) + &
			& (1D0 + Yuk6**2)/Yuk6*dBetaProcDep1Usual() + dZElElOSRight()/2D0 + dZNeuENeuEOSLeft()/2D0 + &
			& dZHpHpOS()/2D0 - 1D0/Yuk6*dZGpHpOSUsual()/2D0 )*&
			& (0.5D0*EL2*ME2*(-1.D0*ME2 + MHp2)*DBLE(Yuk6**INT(2.D0)))/(MW2*SW2)
	case (10)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSAlter()/ME - dMW2Alter()/(2D0*MW2) + &
	...
	case (11)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSUsual()/ME - dMW2Usual()/(2D0*MW2) + &
			& (1D0 + Yuk6**2)/Yuk6*dBetaProcDep2Usual() + dZElElOSRight()/2D0 + dZNeuENeuEOSLeft()/2D0 + &
			& dZHpHpOS()/2D0 - 1D0/Yuk6*dZGpHpOSUsual()/2D0 )*&
			& (0.5D0*EL2*ME2*(-1.D0*ME2 + MHp2)*DBLE(Yuk6**INT(2.D0)))/(MW2*SW2)
	case (12)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSAlter()/ME - dMW2Alter()/(2D0*MW2) + &
	...
	case (13)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSUsual()/ME - dMW2Usual()/(2D0*MW2) + &
			& (1D0 + Yuk6**2)/Yuk6*dBetaProcDep3Usual() + dZElElOSRight()/2D0 + dZNeuENeuEOSLeft()/2D0 + &
			& dZHpHpOS()/2D0 - 1D0/Yuk6*dZGpHpOSUsual()/2D0 )*&
			& (0.5D0*EL2*ME2*(-1.D0*ME2 + MHp2)*DBLE(Yuk6**INT(2.D0)))/(MW2*SW2)
	case (14)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSAlter()/ME - dMW2Alter()/(2D0*MW2) + &
