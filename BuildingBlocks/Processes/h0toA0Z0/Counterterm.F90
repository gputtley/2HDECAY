...
#include "looptools.h"
 ...
 select case (x)
    ...
    case (9)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + (dMZ2Usual()/MZ2 - dMW2Usual()/MW2)/2D0 + dZh0h0OS()/2D0 + dZZ0Z0OS()/2D0 + &
        &dZA0A0OS()/2D0 - SBA/CBA*( dBetaProcDep1Usual() - dAlphaProcDep1Usual() - dZG0A0OSUsual()/2D0 + dZHHh0OSUsual()/2D0))&
            & * (EL2/SW2)*CBA2/CW2 * ( (Mh02**2 + MZ2**2 + MA02**2 - 2D0*Mh02*MZ2 - 2D0*Mh02*MA02 - 2D0*MZ2*MA02)/(4D0*MZ2) )
    case (10)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + (dMZ2Alter()/MZ2 - dMW2Alter()/MW2)/2D0 + dZh0h0OS()/2D0 + dZZ0Z0OS()/2D0 + &
    ...
    case (11)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + (dMZ2Usual()/MZ2 - dMW2Usual()/MW2)/2D0 + dZh0h0OS()/2D0 + dZZ0Z0OS()/2D0 + &
        &dZA0A0OS()/2D0 - SBA/CBA*( dBetaProcDep2Usual() - dAlphaProcDep2Usual() - dZG0A0OSUsual()/2D0 + dZHHh0OSUsual()/2D0))&
            & * (EL2/SW2)*CBA2/CW2 * ( (Mh02**2 + MZ2**2 + MA02**2 - 2D0*Mh02*MZ2 - 2D0*Mh02*MA02 - 2D0*MZ2*MA02)/(4D0*MZ2) )
    case (12)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + (dMZ2Alter()/MZ2 - dMW2Alter()/MW2)/2D0 + dZh0h0OS()/2D0 + dZZ0Z0OS()/2D0 + &
    ...
    case (13)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + (dMZ2Usual()/MZ2 - dMW2Usual()/MW2)/2D0 + dZh0h0OS()/2D0 + dZZ0Z0OS()/2D0 + &
        &dZA0A0OS()/2D0 - SBA/CBA*( dBetaProcDep3Usual() - dAlphaProcDep3Usual() - dZG0A0OSUsual()/2D0 + dZHHh0OSUsual()/2D0))&
            & * (EL2/SW2)*CBA2/CW2 * ( (Mh02**2 + MZ2**2 + MA02**2 - 2D0*Mh02*MZ2 - 2D0*Mh02*MA02 - 2D0*MZ2*MA02)/(4D0*MZ2) )
    case (14)
        totalAmplitude = ( dgAtMZ()/(EL/SW) + (dMZ2Alter()/MZ2 - dMW2Alter()/MW2)/2D0 + dZh0h0OS()/2D0 + dZZ0Z0OS()/2D0 + &
