...
#include "looptools.h"
 ...
 amplitudes(1) = (0.015625D0*EL2*ML2*(-1.D0*(Mh02 + 4.D0*ML2)*B0(Mh02, ML2, ML2) + 8.D0*ML2*B0(ML2, Mh02, ML2) - 1.D0*C0(Mh02, ML&
  &2, ML2, ML2, ML2, Mh02)*(8.D0*Mh02*ML2 + DBLE(Mh0**INT(4.D0)) - 16.D0*DBLE(ML**INT(4.D0))))*DBLE(Yuk1**INT(2.D0)))/ ((Mh02 - 4&
  &.D0*ML2)*MW2*PI2*SW2)

 amplitudes(2) = (-0.015625D0*EL2*ML2*((Mh02 + 4.D0*ML2)*B0(Mh02, ML2, ML2) - 8.D0*ML2*B0(ML2, MHH2, ML2) + (4.D0*(MHH2 - 4.D0*ML&
  &2)*ML2 + Mh02*(MHH2 + 4.D0*ML2))* C0(Mh02, ML2, ML2, ML2, ML2, MHH2))*DBLE(Yuk2**INT(2.D0)))/((Mh02 - 4.D0*ML2)*MW2*PI2*SW2)

 amplitudes(3) = (0.015625D0*EL2*ML2*(B0(Mh02, ML2, ML2) + MA02*C0(Mh02, ML2, ML2, ML2, ML2, MA02))*DBLE(Yuk3**INT(2.D0)))/(MW2*P&
  &I2*SW2)

 amplitudes(4) = (0.015625D0*EL2*ML2*(B0(Mh02, ML2, ML2) + GaugeXiZ*MZ2*C0(Mh02, ML2, ML2, ML2, ML2, GaugeXiZ*MZ2)))/(MW2*PI2*SW2&
  &)

 amplitudes(5) = (0.046875D0*ML2*(2.D0*CAB*EL2*Mh02 + EL2*Mh02*S2A*SBA - 4.D0*CAB*CBA2*Lambda5*MW2*SW2)*Yuk1* (2.D0*B0(Mh02, Mh02&
  &, Mh02) - 2.D0*B0(ML2, Mh02, ML2) + (-3.D0*Mh02 + 8.D0*ML2)*C0(Mh02, ML2, ML2, Mh02, Mh02, ML2)))/ ((Mh02 - 4.D0*ML2)*MW2*PI2*&
  &S2B*SW2)

 amplitudes(6) = (-0.015625D0*CBA*ML2*(EL2*(2.D0*Mh02 + MHH2)*S2A + 2.D0*Lambda5*MW2*(-3.D0*S2A + S2B)*SW2)*Yuk2* (-2.D0*B0(Mh02,&
 ...
 amplitudes(7) = (-0.015625D0*CBA*ML2*(EL2*(2.D0*Mh02 + MHH2)*S2A + 2.D0*Lambda5*MW2*(-3.D0*S2A + S2B)*SW2)*Yuk2* (-2.D0*B0(Mh02,&
  & Mh02, MHH2) + B0(ML2, Mh02, ML2) + B0(ML2, MHH2, ML2) + 2.D0*Mh02*C0(Mh02, ML2, ML2, Mh02, MHH2, ML2) + MHH2*C0(Mh02, ML2, ML&
  &2, Mh02, MHH2, ML2) - 8.D0*ML2*C0(Mh02, ML2, ML2, Mh02, MHH2, ML2)))/((Mh02 - 4.D0*ML2)*MW2*PI2*S2B*SW2)

 amplitudes(8) = (0.015625D0*ML2*SBA*(EL2*(Mh02 + 2.D0*MHH2)*S2A - 2.D0*Lambda5*MW2*(3.D0*S2A + S2B)*SW2)*(-2.D0*B0(Mh02, MHH2, M&
  &HH2) + 2.D0*B0(ML2, MHH2, ML2) + (Mh02 + 2.D0*MHH2 - 8.D0*ML2)*C0(Mh02, ML2, ML2, MHH2, MHH2, ML2))*DBLE(Yuk2**INT(2.D0)))/((M&
  &h02 - 4.D0*ML2)*MW2*PI2*S2B*SW2*Yuk1)

 amplitudes(9) = (0.015625D0*ML2*(EL2*(2.D0*MA02 - 1.D0*Mh02)*S2B*SBA + 2.D0*CAB*(EL2*Mh02 - 2.D0*Lambda5*MW2*SW2))* (2.D0*B0(Mh0&
  &2, MA02, MA02) - 2.D0*B0(ML2, MA02, ML2) + (-2.D0*MA02 + Mh02)*C0(Mh02, ML2, ML2, MA02, MA02, ML2))*DBLE(Yuk3**INT(2.D0)))/ ((&
  &Mh02 - 4.D0*ML2)*MW2*PI2*S2B*SW2*Yuk1)

 amplitudes(10) = (-0.015625D0*CBA*EL2*(MA02 - 1.D0*Mh02)*ML2*Yuk3*(-2.D0*B0(Mh02, MA02, GaugeXiZ*MZ2) + B0(ML2, MA02, ML2) + B0(&
  &ML2, ML2, GaugeXiZ*MZ2) + MA02*C0(Mh02, ML2, ML2, MA02, GaugeXiZ*MZ2, ML2) - 1.D0*Mh02*C0(Mh02, ML2, ML2, MA02, GaugeXiZ*MZ2, &
  &ML2) + GaugeXiZ*MZ2*C0(Mh02, ML2, ML2, MA02, GaugeXiZ*MZ2, ML2)))/((Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)

 amplitudes(11) = (-0.015625D0*CBA*EL2*(MA02 - 1.D0*Mh02)*ML2*Yuk3*(-2.D0*B0(Mh02, MA02, GaugeXiZ*MZ2) + B0(ML2, MA02, ML2) + B0(&
  &ML2, ML2, GaugeXiZ*MZ2) + MA02*C0(Mh02, ML2, ML2, MA02, GaugeXiZ*MZ2, ML2) - 1.D0*Mh02*C0(Mh02, ML2, ML2, MA02, GaugeXiZ*MZ2, &
  &ML2) + GaugeXiZ*MZ2*C0(Mh02, ML2, ML2, MA02, GaugeXiZ*MZ2, ML2)))/((Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)

 amplitudes(12) = (0.015625D0*EL2*Mh02*ML2*SBA*(2.D0*B0(Mh02, GaugeXiZ*MZ2, GaugeXiZ*MZ2) - 2.D0*B0(ML2, ML2, GaugeXiZ*MZ2) + (Mh&
  &02 - 2.D0*GaugeXiZ*MZ2)*C0(Mh02, ML2, ML2, GaugeXiZ*MZ2, GaugeXiZ*MZ2, ML2)))/((Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)

 amplitudes(13) = (0.03125D0*ML2*(-1.D0*EL2*(Mh02 - 2.D0*MHp2)*S2B*SBA + 2.D0*CAB*(EL2*Mh02 - 2.D0*Lambda5*MW2*SW2))* (B0(Mh02, M&
  &Hp2, MHp2) - 1.D0*B0(ML2, 0.D0, MHp2) + (-1.D0*MHp2 + ML2)*C0(Mh02, ML2, ML2, MHp2, MHp2, 0.D0))*DBLE(Yuk3**INT(2.D0)))/ ((Mh0&
  &2 - 4.D0*ML2)*MW2*PI2*S2B*SW2*Yuk1)

 amplitudes(14) = (0.03125D0*CBA*EL2*(Mh02 - 1.D0*MHp2)*ML2*Yuk3*(-1.D0*Mh02*B0(Mh02, MHp2, GaugeXiW*MW2) + 2.D0*ML2*B0(ML2, 0.D0&
  ...
  &2, 0.D0) + 2.D0*GaugeXiW*ML2*MW2*C0(Mh02, ML2, ML2, MHp2, GaugeXiW*MW2, 0.D0)))/(Mh02*(Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)

 amplitudes(15) = (-0.03125D0*CBA*EL2*(Mh02 - 1.D0*MHp2)*ML2*Yuk3*(Mh02*B0(Mh02, MHp2, GaugeXiW*MW2) - 1.D0*(Mh02 - 2.D0*ML2)*B0(&
  ...
  &ugeXiW*ML2*MW2*C0(Mh02, ML2, ML2, MHp2, GaugeXiW*MW2, 0.D0)))/(Mh02*(Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)

 amplitudes(16) = (0.03125D0*EL2*Mh02*ML2*SBA*(B0(Mh02, GaugeXiW*MW2, GaugeXiW*MW2) - 1.D0*B0(ML2, 0.D0, GaugeXiW*MW2) + (ML2 - 1&
  &.D0*GaugeXiW*MW2)*C0(Mh02, ML2, ML2, GaugeXiW*MW2, GaugeXiW*MW2, 0.D0)))/((Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)
 ...
 amplitudes(18) = (0.0078125D0*CBA*EL2*Yuk3*(((1.D0 - 4.D0*SW2)*A0(MZ2))/MZ2 + ((-1.D0 + 4.D0*SW2)*A0(GaugeXiZ*MZ2))/MZ2 + (Mh02*&
 ...
 amplitudes(20) = (-0.015625D0*CBA*EL2*Yuk3*(6.D0*Mh02*MHp2*ML2*B0(Mh02, MHp2, MW2) + 2.D0*Mh02*ML2*MW2*B0(Mh02, MHp2, MW2) - 6.D&
  ...
  &L2, ML2, MHp2, MW2, 0.D0)*DBLE(ML**INT(4.D0))* DBLE(MW**INT(4.D0))))/(Mh02*(Mh0 - 2.D0*ML)*(Mh0 + 2.D0*ML)*MW2*PI2*SW2*Yuk1)
 ...
 amplitudes(21) = (-0.0078125D0*EL2*SBA*(2.D0*A0(MW2) - 2.D0*A0(GaugeXiW*MW2) - 2.D0*(Mh02 - 1.D0*MW2 - 1.D0*GaugeXiW*MW2)*B0(Mh0&
  ...
  &4.D0*ML2)))/(MW2*PI2*SW2*Yuk1)

 amplitudes(22) = (-0.0078125D0*CBA*EL2*Yuk3*(((1.D0 - 4.D0*SW2)*A0(MZ2))/MZ2 + ((-1.D0 + 4.D0*SW2)*A0(GaugeXiZ*MZ2))/MZ2 - (1.D0&
 ...
 amplitudes(24) = (-0.03125D0*CBA*EL2*ML2*Yuk3*(Mh02*(Mh02 - 1.D0*MHp2 - 3.D0*MW2)*B0(Mh02, MHp2, MW2) + Mh02*MW2*B0(ML2, 0.D0, M&
  ...
  &, MW2, 0.D0)*DBLE(MW**INT(4.D0))))/(Mh02*(Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)
 ...
 amplitudes(25) = (0.03125D0*EL2*ML2*SBA*(Mh02*(Mh02 - 3.D0*MW2 - 1.D0*GaugeXiW*MW2)*B0(Mh02, MW2, GaugeXiW*MW2) - 2.D0*Mh02*ML2*&
  ...
  &eXiW*MW2, GaugeXiW*MW2, 0.D0)*DBLE(GaugeXiW**INT(2.D0))* DBLE(MW**INT(4.D0))))/(Mh02*(Mh02 - 4.D0*ML2)*MW2*PI2*SW2*Yuk1)
 ...
 amplitudes(26) = (0.0078125D0*EL2*MW2*SBA*DBLE(CW**INT(-4.D0))*DBLE(MZ**INT(-4.D0))*(-2.D0*Mh02*(Mh02 - 1.D0*MZ2 - 1.D0*GaugeXiZ&
  ...
  &2.D0))))))/ ((Mh02 - 4.D0*ML2)*PI2*SW2*Yuk1)
