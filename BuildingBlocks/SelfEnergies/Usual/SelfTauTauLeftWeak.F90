...
#include "looptools.h"
 ...
 amplitudes(7) = (0.015625D0*EL2*(-1.D0*x + 4.D0*SW2*x - 1.D0*A0(ML2) + 4.D0*SW2*A0(ML2) + A0(MZ2) - 4.D0*SW2*A0(MZ2) + ML2*B0(x,&
 ...
 amplitudes(8) = (0.03125D0*EL2*(-1.D0*x + A0(MW2) + (-1.D0*MW2 + x)*B0(x, 0.D0, MW2)))/(PI2*SW2*x)
