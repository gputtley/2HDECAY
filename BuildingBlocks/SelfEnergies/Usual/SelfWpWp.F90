...
#include "looptools.h"
 ...
 amplitudes(25) = (0.001736111111111111D0*EL2*SBA2*(-6.D0*Mh02*x - 6.D0*MW2*x - 3.D0*(Mh02 - 1.D0*MW2 + x)*A0(Mh02) + 3.D0*(Mh02 &
 ...
 amplitudes(26) = (0.001736111111111111D0*CBA2*EL2*(-6.D0*MHH2*x - 6.D0*MW2*x - 3.D0*(MHH2 - 1.D0*MW2 + x)*A0(MHH2) + 3.D0*(MHH2 &
 ...
 amplitudes(27) = (0.001736111111111111D0*EL2*(-6.D0*MW2*x - 6.D0*MZ2*x - 3.D0*(MW2 - 1.D0*MZ2 + x)*A0(MW2) + 3.D0*(MW2 - 1.D0*MZ&
 ...
 amplitudes(28) = (-0.001736111111111111D0*EL2*(2.D0*x*(-3.D0*MW2 + x) - 3.D0*(MW2 + x)*A0(MW2) + 3.D0*B0(x, 0.D0, MW2)*DBLE((MW2&
  & - 1.D0*x)**INT(2.D0))))/(PI2*x)

 amplitudes(29) = (0.001736111111111111D0*CW2*EL2*(6.D0*MW2*x + 6.D0*MZ2*x + 3.D0*(MW2 - 1.D0*MZ2 + x)*A0(MW2) + 3.D0*(-1.D0*MW2 &
 ...
 amplitudes(30) = (-0.001736111111111111D0*EL2*(2.D0*x*(-3.D0*MW2 + x) - 3.D0*(MW2 + x)*A0(MW2) + 3.D0*B0(x, 0.D0, MW2)*DBLE((MW2&
  & - 1.D0*x)**INT(2.D0))))/(PI2*x)

 amplitudes(31) = (0.001736111111111111D0*CW2*EL2*(6.D0*MW2*x + 6.D0*MZ2*x + 3.D0*(MW2 - 1.D0*MZ2 + x)*A0(MW2) + 3.D0*(-1.D0*MW2 &
  &+ MZ2 + x)*A0(MZ2) + 6.D0*MW2*MZ2*B0(x, MW2, MZ2) + 6.D0*MW2*x*B0(x, MW2, MZ2) + 6.D0*MZ2*x*B0(x, MW2, MZ2) - 3.D0*B0(x, MW2, &
  &MZ2)*DBLE(MW**INT(4.D0)) - 3.D0*B0(x, MW2, MZ2)*DBLE(MZ**INT(4.D0)) - 2.D0*DBLE(x**INT(2.D0)) - 3.D0*B0(x, MW2, MZ2)*DBLE(x**I&
  &NT(2.D0))))/(PI2*SW2*x)

 amplitudes(32) = (-0.003472222222222222D0*EL2*(2.D0*x*(-3.D0*MW2 + x) + 3.D0*(5.D0*MW2 + 11.D0*x)*A0(MW2) + B0(x, 0.D0, MW2)*(48&
  &.D0*MW2*x - 15.D0*DBLE(MW**INT(4.D0)) + 57.D0*DBLE(x**INT(2.D0)))))/(PI2*x)

 amplitudes(33) = (-0.003472222222222222D0*CW2*EL2*(-6.D0*MW2*x - 6.D0*MZ2*x + 3.D0*(5.D0*MW2 - 5.D0*MZ2 + 11.D0*x)*A0(MW2) + (-1&
 ...
 amplitudes(34) = (0.0625D0*EL2*MW2*B0(x, 0.D0, MW2))/PI2

 amplitudes(35) = (0.0625D0*EL2*MW2*SW2*B0(x, MW2, MZ2))/(CW2*PI2)

 amplitudes(36) = (0.0625D0*EL2*MW2*SBA2*B0(x, Mh02, MW2))/(PI2*SW2)

 amplitudes(37) = (0.0625D0*CBA2*EL2*MW2*B0(x, MHH2, MW2))/(PI2*SW2)
