...
#include "looptools.h"
 ...
 amplitudes(4) = (-0.015625D0*EL2*MS2*B0(x, MS2, MZ2))/(MW2*PI2*SW2)
 ...
 amplitudes(8) = (-0.03125D0*CKM12*CKMC12*EL2*MU2*B0(x, MU2, MW2))/(MW2*PI2*SW2)

 amplitudes(9) = (-0.03125D0*CKM22*CKMC22*EL2*MC2*B0(x, MC2, MW2))/(MW2*PI2*SW2)

 amplitudes(10) = (-0.03125D0*CKM32*CKMC32*EL2*MT2*B0(x, MT2, MW2))/(MW2*PI2*SW2)

 amplitudes(11) = (-0.013888888888888888D0*EL2*(-1.D0 + 2.D0*B0(x, 0.D0, MS2)))/PI2

 amplitudes(12) = (-0.006944444444444444D0*EL2*(-3.D0 + 2.D0*SW2)*(-1.D0 + 2.D0*B0(x, MS2, MZ2)))/(CW2*PI2)
