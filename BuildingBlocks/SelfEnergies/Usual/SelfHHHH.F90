...
#include "looptools.h"
 ...
 amplitudes(22) = (0.0078125D0*CBA2*EL2*B0(x, MZ2, MZ2)*DBLE(MHH**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(23) = (0.015625D0*EL2*SBA2*B0(x, MA02, MZ2)*DBLE((MA02 - 1.D0*MHH2)**INT(2.D0)))/(MW2*PI2*SW2)
 ...
 amplitudes(25) = (0.015625D0*CBA2*EL2*B0(x, MW2, MW2)*DBLE(MHH**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(26) = (0.015625D0*EL2*SBA2*B0(x, MHp2, MW2)*DBLE((MHH2 - 1.D0*MHp2)**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(27) = (0.015625D0*EL2*SBA2*B0(x, MHp2, MW2)*DBLE((MHH2 - 1.D0*MHp2)**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(28) = (-0.015625D0*CBA2*EL2*MW2*B0(x, MZ2, MZ2)*DBLE(CW**INT(-4.D0)))/(PI2*SW2)

 amplitudes(29) = (-0.015625D0*CBA2*EL2*MW2*B0(x, MW2, MW2))/(PI2*SW2)

 amplitudes(30) = (-0.015625D0*CBA2*EL2*MW2*B0(x, MW2, MW2))/(PI2*SW2)

 amplitudes(31) = (0.0625D0*CBA2*EL2*MW2*(-1.D0 + 2.D0*B0(x, MZ2, MZ2))*DBLE(CW**INT(-4.D0)))/(PI2*SW2)

 amplitudes(32) = (0.125D0*CBA2*EL2*MW2*(-1.D0 + 2.D0*B0(x, MW2, MW2)))/(PI2*SW2)

 amplitudes(33) = (0.015625D0*EL2*SBA2*(A0(MA02) - 2.D0*A0(MZ2) + (-2.D0*MA02 + MZ2 - 2.D0*x)*B0(x, MA02, MZ2)))/(CW2*PI2*SW2)

 amplitudes(34) = (-0.015625D0*CBA2*EL2*(A0(MZ2) + (MZ2 + 2.D0*x)*B0(x, MZ2, MZ2)))/(CW2*PI2*SW2)

 amplitudes(35) = (0.015625D0*EL2*SBA2*(A0(MHp2) - 2.D0*A0(MW2) + (-2.D0*MHp2 + MW2 - 2.D0*x)*B0(x, MHp2, MW2)))/(PI2*SW2)

 amplitudes(36) = (0.015625D0*EL2*SBA2*(A0(MHp2) - 2.D0*A0(MW2) + (-2.D0*MHp2 + MW2 - 2.D0*x)*B0(x, MHp2, MW2)))/(PI2*SW2)

 amplitudes(37) = (-0.015625D0*CBA2*EL2*(A0(MW2) + (MW2 + 2.D0*x)*B0(x, MW2, MW2)))/(PI2*SW2)

 amplitudes(38) = (-0.015625D0*CBA2*EL2*(A0(MW2) + (MW2 + 2.D0*x)*B0(x, MW2, MW2)))/(PI2*SW2)
