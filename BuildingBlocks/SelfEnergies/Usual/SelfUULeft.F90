...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*CKM11*CKMC11*EL2*(-1.D0*MD2*A0(MD2) + MD2*A0(MW2) - 1.D0*MD2*MW2*B0(x, MD2, MW2) + MD2*x*B0(x, MD2, &
  &MW2) + B0(x, MD2, MW2)*DBLE(MD**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(9) = (0.015625D0*CKM12*CKMC12*EL2*(-1.D0*MS2*A0(MS2) + MS2*A0(MW2) - 1.D0*MS2*MW2*B0(x, MS2, MW2) + MS2*x*B0(x, MS2, &
  &MW2) + B0(x, MS2, MW2)*DBLE(MS**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(10) = (0.015625D0*CKM13*CKMC13*EL2*(-1.D0*MB2*A0(MB2) + MB2*A0(MW2) - 1.D0*MB2*MW2*B0(x, MB2, MW2) + MB2*x*B0(x, MB2,&
  & MW2) + B0(x, MB2, MW2)*DBLE(MB**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(11) = (0.027777777777777776D0*EL2*(-1.D0*x - 1.D0*A0(MU2) + MU2*B0(x, 0.D0, MU2) + x*B0(x, 0.D0, MU2)))/(PI2*x)

 amplitudes(12) = (0.001736111111111111D0*EL2*(-9.D0*x + 24.D0*SW2*x - 9.D0*A0(MU2) + 24.D0*SW2*A0(MU2) + 9.D0*A0(MZ2) - 24.D0*SW&
  &2*A0(MZ2) + 9.D0*MU2*B0(x, MU2, MZ2) - 9.D0*MZ2*B0(x, MU2, MZ2) - 24.D0*MU2*SW2*B0(x, MU2, MZ2) + 24.D0*MZ2*SW2*B0(x, MU2, MZ2&
  &) + 9.D0*x*B0(x, MU2, MZ2) - 24.D0*SW2*x*B0(x, MU2, MZ2) - 16.D0*x*DBLE(SW**INT(4.D0)) - 16.D0*A0(MU2)*DBLE(SW**INT(4.D0)) + 1&
  &6.D0*A0(MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MU2*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*MZ2*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0&
  &)) + 16.D0*x*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0))))/ (CW2*PI2*SW2*x)

 amplitudes(13) = (0.03125D0*CKM11*CKMC11*EL2*(-1.D0*x - 1.D0*A0(MD2) + A0(MW2) + MD2*B0(x, MD2, MW2) - 1.D0*MW2*B0(x, MD2, MW2) &
  &+ x*B0(x, MD2, MW2)))/(PI2*SW2*x)

 amplitudes(14) = (0.03125D0*CKM12*CKMC12*EL2*(-1.D0*x - 1.D0*A0(MS2) + A0(MW2) + MS2*B0(x, MS2, MW2) - 1.D0*MW2*B0(x, MS2, MW2) &
  &+ x*B0(x, MS2, MW2)))/(PI2*SW2*x)

 amplitudes(15) = (0.03125D0*CKM13*CKMC13*EL2*(-1.D0*x - 1.D0*A0(MB2) + A0(MW2) + MB2*B0(x, MB2, MW2) - 1.D0*MW2*B0(x, MB2, MW2) &
