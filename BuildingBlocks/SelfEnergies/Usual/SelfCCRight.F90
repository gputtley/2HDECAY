...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*CKM21*CKMC21*EL2*(-1.D0*MC2*A0(MD2) + MC2*A0(MW2) + MC2*MD2*B0(x, MD2, MW2) - 1.D0*MC2*MW2*B0(x, MD2&
  &, MW2) + MC2*x*B0(x, MD2, MW2)))/(MW2*PI2*SW2*x)

 amplitudes(9) = (0.015625D0*CKM22*CKMC22*EL2*(-1.D0*MC2*A0(MS2) + MC2*A0(MW2) + MC2*MS2*B0(x, MS2, MW2) - 1.D0*MC2*MW2*B0(x, MS2&
  &, MW2) + MC2*x*B0(x, MS2, MW2)))/(MW2*PI2*SW2*x)

 amplitudes(10) = (0.015625D0*CKM23*CKMC23*EL2*(-1.D0*MC2*A0(MB2) + MC2*A0(MW2) + MB2*MC2*B0(x, MB2, MW2) - 1.D0*MC2*MW2*B0(x, MB&
  &2, MW2) + MC2*x*B0(x, MB2, MW2)))/(MW2*PI2*SW2*x)

 amplitudes(11) = (0.027777777777777776D0*EL2*(-1.D0*x - 1.D0*A0(MC2) + MC2*B0(x, 0.D0, MC2) + x*B0(x, 0.D0, MC2)))/(PI2*x)

 amplitudes(12) = (0.001736111111111111D0*EL2*(-16.D0*x*DBLE(SW**INT(4.D0)) - 16.D0*A0(MC2)*DBLE(SW**INT(4.D0)) + 16.D0*A0(MZ2)*D&
