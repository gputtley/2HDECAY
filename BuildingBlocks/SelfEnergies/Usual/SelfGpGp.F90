...
#include "looptools.h"
 ...
 amplitudes(25) = (0.015625D0*EL2*SBA2*B0(x, Mh02, MW2)*DBLE(Mh0**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(26) = (0.015625D0*CBA2*EL2*B0(x, MHH2, MW2)*DBLE(MHH**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(27) = (0.015625D0*EL2*MW2*(CW2 - 1.D0*SW2)*B0(x, MW2, MZ2))/(CW2*PI2*SW2)

 amplitudes(28) = (0.015625D0*EL2*MW2*(CW2 - 1.D0*SW2)*B0(x, MW2, MZ2))/(CW2*PI2*SW2)

 amplitudes(29) = (0.125D0*EL2*MW2*(-1.D0 + 2.D0*B0(x, 0.D0, MW2)))/PI2

 amplitudes(30) = (0.125D0*EL2*MW2*SW2*(-1.D0 + 2.D0*B0(x, MW2, MZ2)))/(CW2*PI2)

 amplitudes(31) = (0.0625D0*EL2*(A0(MW2) - 2.D0*(MW2 + x)*B0(x, 0.D0, MW2)))/PI2

 amplitudes(32) = (0.015625D0*EL2*(A0(MW2) - 2.D0*A0(MZ2) + (-2.D0*MW2 + MZ2 - 2.D0*x)*B0(x, MW2, MZ2))*DBLE((CW2 - 1.D0*SW2)**IN&
  &T(2.D0)))/(CW2*PI2*SW2)

 amplitudes(33) = (0.015625D0*EL2*SBA2*(A0(Mh02) - 2.D0*A0(MW2) + (-2.D0*Mh02 + MW2 - 2.D0*x)*B0(x, Mh02, MW2)))/(PI2*SW2)

 amplitudes(34) = (0.015625D0*CBA2*EL2*(A0(MHH2) - 2.D0*A0(MW2) + (-2.D0*MHH2 + MW2 - 2.D0*x)*B0(x, MHH2, MW2)))/(PI2*SW2)

 amplitudes(35) = (0.015625D0*EL2*(-2.D0*A0(MW2) + A0(MZ2) + (MW2 - 2.D0*(MZ2 + x))*B0(x, MW2, MZ2)))/(PI2*SW2)
