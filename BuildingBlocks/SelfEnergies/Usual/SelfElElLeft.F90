...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*EL2*(-1.D0*x + 4.D0*SW2*x - 1.D0*A0(ME2) + 4.D0*SW2*A0(ME2) + A0(MZ2) - 4.D0*SW2*A0(MZ2) + ME2*B0(x,&
  & ME2, MZ2) - 1.D0*MZ2*B0(x, ME2, MZ2) - 4.D0*ME2*SW2*B0(x, ME2, MZ2) + 4.D0*MZ2*SW2*B0(x, ME2, MZ2) + x*B0(x, ME2, MZ2) - 4.D0&
  &*SW2*x*B0(x, ME2, MZ2) - 4.D0*x*DBLE(SW**INT(4.D0)) - 4.D0*A0(ME2)*DBLE(SW**INT(4.D0)) + 4.D0*A0(MZ2)*DBLE(SW**INT(4.D0)) + 4.&
  &D0*ME2*B0(x, ME2, MZ2)*DBLE(SW**INT(4.D0)) - 4.D0*MZ2*B0(x, ME2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*x*B0(x, ME2, MZ2)*DBLE(SW**IN&
