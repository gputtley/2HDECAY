...
#include "looptools.h"
 ...
 amplitudes(9) = (-0.03125D0*EL2*ME2*(2.D0*A0(ME2) - 1.D0*x*B0(x, ME2, ME2))*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(10) = (-0.03125D0*EL2*MM2*(2.D0*A0(MM2) - 1.D0*x*B0(x, MM2, MM2))*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(11) = (-0.03125D0*EL2*ML2*(2.D0*A0(ML2) - 1.D0*x*B0(x, ML2, ML2))*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)
