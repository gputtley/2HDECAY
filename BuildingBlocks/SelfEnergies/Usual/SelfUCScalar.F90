...
#include "looptools.h"
 ...
 amplitudes(4) = (-0.03125D0*CKM21*CKMC11*EL2*MD2*B0(x, MD2, MW2))/(MW2*PI2*SW2)

 amplitudes(5) = (-0.03125D0*CKM22*CKMC12*EL2*MS2*B0(x, MS2, MW2))/(MW2*PI2*SW2)

 amplitudes(6) = (-0.03125D0*CKM23*CKMC13*EL2*MB2*B0(x, MB2, MW2))/(MW2*PI2*SW2)
