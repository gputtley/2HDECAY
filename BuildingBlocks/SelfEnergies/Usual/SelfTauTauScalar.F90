...
#include "looptools.h"
 ...
 amplitudes(4) = (-0.015625D0*EL2*ML2*B0(x, ML2, MZ2))/(MW2*PI2*SW2)

 amplitudes(5) = 0.D0

 amplitudes(6) = 0.D0

 amplitudes(7) = (-0.125D0*EL2*(-1.D0 + 2.D0*B0(x, 0.D0, ML2)))/PI2

 amplitudes(8) = (-0.0625D0*EL2*(-1.D0 + 2.D0*SW2)*(-1.D0 + 2.D0*B0(x, ML2, MZ2)))/(CW2*PI2)
