...
#include "looptools.h"
 ...
 amplitudes(4) = (0.015625D0*CKM21*CKMC11*EL2*(-1.D0*MC*MU*A0(MD2) + MC*MU*A0(MW2) + MC*MD2*MU*B0(x, MD2, MW2) - 1.D0*MC*MU*MW2*B&
  &0(x, MD2, MW2) + MC*MU*x*B0(x, MD2, MW2)))/(MW2*PI2*SW2*x)

 amplitudes(5) = (0.015625D0*CKM22*CKMC12*EL2*(-1.D0*MC*MU*A0(MS2) + MC*MU*A0(MW2) + MC*MS2*MU*B0(x, MS2, MW2) - 1.D0*MC*MU*MW2*B&
  &0(x, MS2, MW2) + MC*MU*x*B0(x, MS2, MW2)))/(MW2*PI2*SW2*x)

 amplitudes(6) = (0.015625D0*CKM23*CKMC13*EL2*(-1.D0*MC*MU*A0(MB2) + MC*MU*A0(MW2) + MB2*MC*MU*B0(x, MB2, MW2) - 1.D0*MC*MU*MW2*B&
  &0(x, MB2, MW2) + MC*MU*x*B0(x, MB2, MW2)))/(MW2*PI2*SW2*x)
