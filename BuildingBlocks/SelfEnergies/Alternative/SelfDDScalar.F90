...
#include "looptools.h"
 ...
 amplitudes(40) = (-0.0078125D0*EL2*SBA*Yuk1*A0(MZ2))/(MW2*PI2*SW2)

 amplitudes(41) = (0.015625D0*(EL2*(Mh02 - 2.D0*MHp2)*S2B*SBA + CAB*(-2.D0*EL2*Mh02 + 4.D0*Lambda5*MW2*SW2))*Yuk1*A0(MHp2))/(Mh02&
  &*MW2*PI2*S2B*SW2)

 amplitudes(42) = (-0.015625D0*EL2*SBA*Yuk1*A0(MW2))/(MW2*PI2*SW2)
 ...
 amplitudes(46) = (-0.0078125D0*CBA*EL2*Yuk2*A0(MZ2))/(MW2*PI2*SW2)

 amplitudes(47) = (0.015625D0*(CBA*EL2*(MHH2 - 2.D0*MHp2)*S2B - 2.D0*EL2*MHH2*SAB + 4.D0*Lambda5*MW2*SAB*SW2)*Yuk2*A0(MHp2))/(MHH&
  &2*MW2*PI2*S2B*SW2)

 amplitudes(48) = (-0.015625D0*CBA*EL2*Yuk2*A0(MW2))/(MW2*PI2*SW2)

 amplitudes(49) = (0.015625D0*EL2*SBA*Yuk1*A0(MZ2))/(CW2*Mh02*PI2*SW2)

 amplitudes(50) = (0.015625D0*EL2*SBA*Yuk1*A0(MW2))/(Mh02*PI2*SW2)

 amplitudes(51) = (0.015625D0*EL2*SBA*Yuk1*A0(MW2))/(Mh02*PI2*SW2)

 amplitudes(52) = (0.015625D0*CBA*EL2*Yuk2*A0(MZ2))/(CW2*MHH2*PI2*SW2)

 amplitudes(53) = (0.015625D0*CBA*EL2*Yuk2*A0(MW2))/(MHH2*PI2*SW2)

 amplitudes(54) = (0.015625D0*CBA*EL2*Yuk2*A0(MW2))/(MHH2*PI2*SW2)
 ...
 amplitudes(57) = (0.03125D0*EL2*SBA*Yuk1*(MZ2 - 2.D0*A0(MZ2)))/(CW2*Mh02*PI2*SW2)

 amplitudes(58) = (0.0625D0*EL2*SBA*Yuk1*(MW2 - 2.D0*A0(MW2)))/(Mh02*PI2*SW2)

 amplitudes(59) = (0.03125D0*CBA*EL2*Yuk2*(MZ2 - 2.D0*A0(MZ2)))/(CW2*MHH2*PI2*SW2)

 amplitudes(60) = (0.0625D0*CBA*EL2*Yuk2*(MW2 - 2.D0*A0(MW2)))/(MHH2*PI2*SW2)
 ...
 amplitudes(95) = (-0.015625D0*EL2*MD2*B0(x, MD2, MZ2))/(MW2*PI2*SW2)
 ...
 amplitudes(99) = (-0.03125D0*CKM11*CKMC11*EL2*MU2*B0(x, MU2, MW2))/(MW2*PI2*SW2)

 amplitudes(100) = (-0.03125D0*CKM21*CKMC21*EL2*MC2*B0(x, MC2, MW2))/(MW2*PI2*SW2)

 amplitudes(101) = (-0.03125D0*CKM31*CKMC31*EL2*MT2*B0(x, MT2, MW2))/(MW2*PI2*SW2)

 amplitudes(102) = (-0.013888888888888888D0*EL2*(-1.D0 + 2.D0*B0(x, 0.D0, MD2)))/PI2

 amplitudes(103) = (-0.006944444444444444D0*EL2*(-3.D0 + 2.D0*SW2)*(-1.D0 + 2.D0*B0(x, MD2, MZ2)))/(CW2*PI2)
