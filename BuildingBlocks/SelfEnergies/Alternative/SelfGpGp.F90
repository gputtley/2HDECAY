...
#include "looptools.h"
 ...
 amplitudes(4) = (0.0078125D0*EL2*(CBA2*MHH2 + Mh02*SBA2)*A0(MZ2))/(MW2*PI2*SW2)
 ...
 amplitudes(6) = (0.03125D0*EL2*(CBA2*MHH2 + Mh02*SBA2)*A0(MW2))/(MW2*PI2*SW2)
 ...
 amplitudes(31) = (-0.0078125D0*EL2*Mh02*SBA2*A0(MZ2))/(MW2*PI2*SW2)

 amplitudes(32) = (0.015625D0*SBA*(EL2*(Mh02 - 2.D0*MHp2)*S2B*SBA + CAB*(-2.D0*EL2*Mh02 + 4.D0*Lambda5*MW2*SW2))*A0(MHp2))/(MW2*P&
  &I2*S2B*SW2)

 amplitudes(33) = (-0.015625D0*EL2*Mh02*SBA2*A0(MW2))/(MW2*PI2*SW2)
 ...
 amplitudes(37) = (-0.0078125D0*CBA2*EL2*MHH2*A0(MZ2))/(MW2*PI2*SW2)

 amplitudes(38) = (0.015625D0*CBA*(CBA*EL2*(MHH2 - 2.D0*MHp2)*S2B - 2.D0*EL2*MHH2*SAB + 4.D0*Lambda5*MW2*SAB*SW2)*A0(MHp2))/(MW2*&
  &PI2*S2B*SW2)

 amplitudes(39) = (-0.015625D0*CBA2*EL2*MHH2*A0(MW2))/(MW2*PI2*SW2)

 amplitudes(40) = (0.015625D0*EL2*SBA2*A0(MZ2))/(CW2*PI2*SW2)

 amplitudes(41) = (0.015625D0*EL2*SBA2*A0(MW2))/(PI2*SW2)

 amplitudes(42) = (0.015625D0*EL2*SBA2*A0(MW2))/(PI2*SW2)

 amplitudes(43) = (0.015625D0*CBA2*EL2*A0(MZ2))/(CW2*PI2*SW2)

 amplitudes(44) = (0.015625D0*CBA2*EL2*A0(MW2))/(PI2*SW2)

 amplitudes(45) = (0.015625D0*CBA2*EL2*A0(MW2))/(PI2*SW2)

 amplitudes(46) = (0.03125D0*EL2*SBA2*(MZ2 - 2.D0*A0(MZ2)))/(CW2*PI2*SW2)

 amplitudes(47) = (0.0625D0*EL2*SBA2*(MW2 - 2.D0*A0(MW2)))/(PI2*SW2)

 amplitudes(48) = (0.03125D0*CBA2*EL2*(MZ2 - 2.D0*A0(MZ2)))/(CW2*PI2*SW2)

 amplitudes(49) = (0.0625D0*CBA2*EL2*(MW2 - 2.D0*A0(MW2)))/(PI2*SW2)
 ...
 amplitudes(96) = (0.015625D0*EL2*SBA2*B0(x, Mh02, MW2)*DBLE(Mh0**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(97) = (0.015625D0*CBA2*EL2*B0(x, MHH2, MW2)*DBLE(MHH**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(98) = (0.015625D0*EL2*MW2*(CW2 - 1.D0*SW2)*B0(x, MW2, MZ2))/(CW2*PI2*SW2)

 amplitudes(99) = (0.015625D0*EL2*MW2*(CW2 - 1.D0*SW2)*B0(x, MW2, MZ2))/(CW2*PI2*SW2)

 amplitudes(100) = (0.125D0*EL2*MW2*(-1.D0 + 2.D0*B0(x, 0.D0, MW2)))/PI2

 amplitudes(101) = (0.125D0*EL2*MW2*SW2*(-1.D0 + 2.D0*B0(x, MW2, MZ2)))/(CW2*PI2)

 amplitudes(102) = (0.0625D0*EL2*(A0(MW2) - 2.D0*(MW2 + x)*B0(x, 0.D0, MW2)))/PI2

 amplitudes(103) = (0.015625D0*EL2*(A0(MW2) - 2.D0*A0(MZ2) + (-2.D0*MW2 + MZ2 - 2.D0*x)*B0(x, MW2, MZ2))*DBLE((CW2 - 1.D0*SW2)**I&
  &NT(2.D0)))/(CW2*PI2*SW2)

 amplitudes(104) = (0.015625D0*EL2*SBA2*(A0(Mh02) - 2.D0*A0(MW2) + (-2.D0*Mh02 + MW2 - 2.D0*x)*B0(x, Mh02, MW2)))/(PI2*SW2)

 amplitudes(105) = (0.015625D0*CBA2*EL2*(A0(MHH2) - 2.D0*A0(MW2) + (-2.D0*MHH2 + MW2 - 2.D0*x)*B0(x, MHH2, MW2)))/(PI2*SW2)

 amplitudes(106) = (0.015625D0*EL2*(-2.D0*A0(MW2) + A0(MZ2) + (MW2 - 2.D0*(MZ2 + x))*B0(x, MW2, MZ2)))/(PI2*SW2)
