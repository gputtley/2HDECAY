...
#include "looptools.h"
 ...
 amplitudes(4) = (0.0234375D0*EL2*(CBA2*MHH2 + Mh02*SBA2)*A0(MZ2))/(MW2*PI2*SW2)
 ...
 amplitudes(6) = (0.015625D0*EL2*(CBA2*MHH2 + Mh02*SBA2)*A0(MW2))/(MW2*PI2*SW2)
 ...
 amplitudes(30) = (-0.0078125D0*EL2*Mh02*SBA2*A0(MZ2))/(MW2*PI2*SW2)

 amplitudes(31) = (0.015625D0*SBA*(EL2*(Mh02 - 2.D0*MHp2)*S2B*SBA + CAB*(-2.D0*EL2*Mh02 + 4.D0*Lambda5*MW2*SW2))*A0(MHp2))/(MW2*P&
  &I2*S2B*SW2)

 amplitudes(32) = (-0.015625D0*EL2*Mh02*SBA2*A0(MW2))/(MW2*PI2*SW2)
 ...
 amplitudes(36) = (-0.0078125D0*CBA2*EL2*MHH2*A0(MZ2))/(MW2*PI2*SW2)

 amplitudes(37) = (0.015625D0*CBA*(CBA*EL2*(MHH2 - 2.D0*MHp2)*S2B - 2.D0*EL2*MHH2*SAB + 4.D0*Lambda5*MW2*SAB*SW2)*A0(MHp2))/(MW2*&
  &PI2*S2B*SW2)

 amplitudes(38) = (-0.015625D0*CBA2*EL2*MHH2*A0(MW2))/(MW2*PI2*SW2)

 amplitudes(39) = (0.015625D0*EL2*SBA2*A0(MZ2))/(CW2*PI2*SW2)

 amplitudes(40) = (0.015625D0*EL2*SBA2*A0(MW2))/(PI2*SW2)

 amplitudes(41) = (0.015625D0*EL2*SBA2*A0(MW2))/(PI2*SW2)

 amplitudes(42) = (0.015625D0*CBA2*EL2*A0(MZ2))/(CW2*PI2*SW2)

 amplitudes(43) = (0.015625D0*CBA2*EL2*A0(MW2))/(PI2*SW2)

 amplitudes(44) = (0.015625D0*CBA2*EL2*A0(MW2))/(PI2*SW2)

 amplitudes(45) = (0.03125D0*EL2*SBA2*(MZ2 - 2.D0*A0(MZ2)))/(CW2*PI2*SW2)

 amplitudes(46) = (0.0625D0*EL2*SBA2*(MW2 - 2.D0*A0(MW2)))/(PI2*SW2)

 amplitudes(47) = (0.03125D0*CBA2*EL2*(MZ2 - 2.D0*A0(MZ2)))/(CW2*PI2*SW2)

 amplitudes(48) = (0.0625D0*CBA2*EL2*(MW2 - 2.D0*A0(MW2)))/(PI2*SW2)
 ...
 amplitudes(60) = (0.015625D0*EL2*SBA2*B0(x, Mh02, MZ2)*DBLE(Mh0**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(61) = (0.015625D0*CBA2*EL2*B0(x, MHH2, MZ2)*DBLE(MHH**INT(4.D0)))/(MW2*PI2*SW2)

 amplitudes(62) = (0.015625D0*EL2*MW2*B0(x, MW2, MW2))/(PI2*SW2)

 amplitudes(63) = (0.015625D0*EL2*MW2*B0(x, MW2, MW2))/(PI2*SW2)

 amplitudes(64) = (0.015625D0*EL2*SBA2*(A0(Mh02) - 2.D0*A0(MZ2) + (-2.D0*Mh02 + MZ2 - 2.D0*x)*B0(x, Mh02, MZ2)))/(CW2*PI2*SW2)

 amplitudes(65) = (0.015625D0*CBA2*EL2*(A0(MHH2) - 2.D0*A0(MZ2) + (-2.D0*MHH2 + MZ2 - 2.D0*x)*B0(x, MHH2, MZ2)))/(CW2*PI2*SW2)

 amplitudes(66) = (-0.015625D0*EL2*(A0(MW2) + (MW2 + 2.D0*x)*B0(x, MW2, MW2)))/(PI2*SW2)

 amplitudes(67) = (-0.015625D0*EL2*(A0(MW2) + (MW2 + 2.D0*x)*B0(x, MW2, MW2)))/(PI2*SW2)
