...
#include "looptools.h"
 ...
 amplitudes(78) = (0.015625D0*EL2*ML2*B0(x, Mh02, ML2)*DBLE(Yuk1**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(79) = (0.015625D0*EL2*ML2*B0(x, MHH2, ML2)*DBLE(Yuk2**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(80) = (-0.015625D0*EL2*ML2*B0(x, MA02, ML2)*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)
