...
#include "looptools.h"
 ...
 amplitudes(35) = (-0.015625D0*CBA2*EL2*A0(MZ2))/(CW2*PI2*SW2)

 amplitudes(36) = (0.03125D0*CBA*(CBA*EL2*(MHH2 - 2.D0*MHp2)*S2B - 2.D0*EL2*MHH2*SAB + 4.D0*Lambda5*MW2*SAB*SW2)*A0(MHp2))/(CW2*M&
  &HH2*PI2*S2B*SW2)

 amplitudes(37) = (-0.03125D0*CBA2*EL2*A0(MW2))/(CW2*PI2*SW2)

 amplitudes(38) = (0.03125D0*EL2*MW2*SBA2*A0(MZ2)*DBLE(CW**INT(-4.D0)))/(Mh02*PI2*SW2)

 amplitudes(39) = (0.03125D0*EL2*MW2*SBA2*A0(MW2))/(CW2*Mh02*PI2*SW2)

 amplitudes(40) = (0.03125D0*EL2*MW2*SBA2*A0(MW2))/(CW2*Mh02*PI2*SW2)

 amplitudes(41) = (0.03125D0*CBA2*EL2*MW2*A0(MZ2)*DBLE(CW**INT(-4.D0)))/(MHH2*PI2*SW2)

 amplitudes(42) = (0.03125D0*CBA2*EL2*MW2*A0(MW2))/(CW2*MHH2*PI2*SW2)

 amplitudes(43) = (0.03125D0*CBA2*EL2*MW2*A0(MW2))/(CW2*MHH2*PI2*SW2)

 amplitudes(44) = (0.0625D0*EL2*MW2*SBA2*(MZ2 - 2.D0*A0(MZ2))*DBLE(CW**INT(-4.D0)))/(Mh02*PI2*SW2)

 amplitudes(45) = (0.125D0*EL2*MW2*SBA2*(MW2 - 2.D0*A0(MW2)))/(CW2*Mh02*PI2*SW2)

 amplitudes(46) = (0.0625D0*CBA2*EL2*MW2*(MZ2 - 2.D0*A0(MZ2))*DBLE(CW**INT(-4.D0)))/(MHH2*PI2*SW2)

 amplitudes(47) = (0.125D0*CBA2*EL2*MW2*(MW2 - 2.D0*A0(MW2)))/(CW2*MHH2*PI2*SW2)
 ...
 amplitudes(62) = (0.001736111111111111D0*EL2*SBA2*(-6.D0*Mh02*x - 6.D0*MZ2*x - 3.D0*(Mh02 - 1.D0*MZ2 + x)*A0(Mh02) + 3.D0*(Mh02 &
 ...
 amplitudes(63) = (0.001736111111111111D0*CBA2*EL2*(-6.D0*MHH2*x - 6.D0*MZ2*x - 3.D0*(MHH2 - 1.D0*MZ2 + x)*A0(MHH2) + 3.D0*(MHH2 &
 ...
 amplitudes(65) = (-0.001736111111111111D0*EL2*(12.D0*MW2 - 2.D0*x + 6.D0*A0(MW2) + 3.D0*(4.D0*MW2 - 1.D0*x)*B0(x, MW2, MW2))*DBL&
  &E((CW2 - 1.D0*SW2)**INT(2.D0)))/ (CW2*PI2*SW2)

 amplitudes(66) = (0.001736111111111111D0*CW2*EL2*(12.D0*MW2 - 2.D0*x + 6.D0*A0(MW2) + 3.D0*(4.D0*MW2 - 1.D0*x)*B0(x, MW2, MW2)))&
  &/(PI2*SW2)

 amplitudes(67) = (0.001736111111111111D0*CW2*EL2*(12.D0*MW2 - 2.D0*x + 6.D0*A0(MW2) + 3.D0*(4.D0*MW2 - 1.D0*x)*B0(x, MW2, MW2)))&
  &/(PI2*SW2)

 amplitudes(68) = (-0.003472222222222222D0*CW2*EL2*(2.D0*(-6.D0*MW2 + x) + 66.D0*A0(MW2) + (96.D0*MW2 + 57.D0*x)*B0(x, MW2, MW2))&
  &)/(PI2*SW2)

 amplitudes(69) = (0.0625D0*EL2*MW2*SBA2*B0(x, Mh02, MZ2)*DBLE(CW**INT(-4.D0)))/(PI2*SW2)

 amplitudes(70) = (0.0625D0*CBA2*EL2*MW2*B0(x, MHH2, MZ2)*DBLE(CW**INT(-4.D0)))/(PI2*SW2)

 amplitudes(71) = (0.0625D0*EL2*MW2*SW2*B0(x, MW2, MW2))/(CW2*PI2)

 amplitudes(72) = (0.0625D0*EL2*MW2*SW2*B0(x, MW2, MW2))/(CW2*PI2)
