...
#include "looptools.h"
 ...
 amplitudes(9) = (0.0625D0*ME2*(EL2*(2.D0*MA02 - 1.D0*Mh02)*S2B*SBA + 2.D0*CAB*(EL2*Mh02 - 2.D0*Lambda5*MW2*SW2))*Yuk1*A0(ME2))/(&
  &Mh02*MW2*PI2*S2B*SW2)

 amplitudes(10) = (0.0625D0*MM2*(EL2*(2.D0*MA02 - 1.D0*Mh02)*S2B*SBA + 2.D0*CAB*(EL2*Mh02 - 2.D0*Lambda5*MW2*SW2))*Yuk1*A0(MM2))/&
  &(Mh02*MW2*PI2*S2B*SW2)

 amplitudes(11) = (0.0625D0*ML2*(EL2*(2.D0*MA02 - 1.D0*Mh02)*S2B*SBA + 2.D0*CAB*(EL2*Mh02 - 2.D0*Lambda5*MW2*SW2))*Yuk1*A0(ML2))/&
  &(Mh02*MW2*PI2*S2B*SW2)
 ...
 amplitudes(18) = (0.0625D0*ME2*(CBA*EL2*(2.D0*MA02 - 1.D0*MHH2)*S2B + 2.D0*SAB*(EL2*MHH2 - 2.D0*Lambda5*MW2*SW2))*Yuk2*A0(ME2))/&
  &(MHH2*MW2*PI2*S2B*SW2)

 amplitudes(19) = (0.0625D0*MM2*(CBA*EL2*(2.D0*MA02 - 1.D0*MHH2)*S2B + 2.D0*SAB*(EL2*MHH2 - 2.D0*Lambda5*MW2*SW2))*Yuk2*A0(MM2))/&
  &(MHH2*MW2*PI2*S2B*SW2)

 amplitudes(20) = (0.0625D0*ML2*(CBA*EL2*(2.D0*MA02 - 1.D0*MHH2)*S2B + 2.D0*SAB*(EL2*MHH2 - 2.D0*Lambda5*MW2*SW2))*Yuk2*A0(ML2))/&
  &(MHH2*MW2*PI2*S2B*SW2)
 ...
 amplitudes(49) = (-0.03125D0*EL2*ME2*(2.D0*A0(ME2) - 1.D0*x*B0(x, ME2, ME2))*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(50) = (-0.03125D0*EL2*MM2*(2.D0*A0(MM2) - 1.D0*x*B0(x, MM2, MM2))*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(51) = (-0.03125D0*EL2*ML2*(2.D0*A0(ML2) - 1.D0*x*B0(x, ML2, ML2))*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)
