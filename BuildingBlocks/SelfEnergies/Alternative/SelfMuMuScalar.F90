...
#include "looptools.h"
 ...
 amplitudes(95) = (-0.015625D0*EL2*MM2*B0(x, MM2, MZ2))/(MW2*PI2*SW2)

 amplitudes(96) = 0.D0

 amplitudes(97) = 0.D0

 amplitudes(98) = (-0.125D0*EL2*(-1.D0 + 2.D0*B0(x, 0.D0, MM2)))/PI2

 amplitudes(99) = (-0.0625D0*EL2*(-1.D0 + 2.D0*SW2)*(-1.D0 + 2.D0*B0(x, MM2, MZ2)))/(CW2*PI2)
