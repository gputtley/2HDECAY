...
#include "looptools.h"
 ...
 amplitudes(92) = (0.015625D0*EL2*MM2*B0(x, Mh02, MM2)*DBLE(Yuk1**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(93) = (0.015625D0*EL2*MM2*B0(x, MHH2, MM2)*DBLE(Yuk2**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(94) = (-0.015625D0*EL2*MM2*B0(x, MA02, MM2)*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)
